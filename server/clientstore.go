 ...
 * For synchronization reasons, user administration (writes) is fulfilled by the AdminClientstore.
 */
...
//go:generate mockgen -destination mock/mock_clientstore.go -package mock . Clientstore
