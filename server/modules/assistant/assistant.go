...
func NewAssistantManager(srv *server.Server) *AssistantManager {
	return &AssistantManager{
		srv: srv,
	}
}

func (am *AssistantManager) PrerequisiteModules() []string {
	return nil
}

func (am *AssistantManager) Init(config module.ModuleConfig) (err error) {
...
func (am *AssistantManager) Start() error {
	am.isRunning = true

	return nil
}

func (am *AssistantManager) Stop() error {
	am.isRunning = false

	return nil
}

func (am *AssistantManager) IsRunning() bool {
	return am.isRunning
}
