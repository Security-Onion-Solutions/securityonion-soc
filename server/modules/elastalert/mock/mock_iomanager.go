...
//
//	mockgen -destination /Users/jbrower/LWP/so-repos/securityonion-soc/server/modules/elastalert/mock/mock_iomanager.go -package mock github.com/security-onion-solutions/securityonion-soc/server/modules/elastalert IOManager
//
...
func (m *MockIOManager) JoinPath(arg0 ...string) string {
	m.ctrl.T.Helper()
	varargs := []any{}
	for _, a := range arg0 {
...
func (mr *MockIOManagerMockRecorder) JoinPath(arg0 ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "JoinPath", reflect.TypeOf((*MockIOManager)(nil).JoinPath), arg0...)
}
