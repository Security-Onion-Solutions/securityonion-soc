...
type Auditable struct {
	// The ID assigned to this case by the server. This is a read-only field.
	Id string `json:"id,omitempty" example:"PdFc-JIBLkNJ8-bDfz47"`
	// The date and time that this case was created. This is a read-only field.
	CreateTime *time.Time `json:"createTime" example:"2024-11-14T15:03:22Z"`
	// The date and time that this case was last modified. This is a read-only field.
