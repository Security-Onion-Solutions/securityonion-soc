...
const i18n = {
  translations: {
    "en-US": {
      ...
      agentStudioMemoryReconcileMessages: 'Messages per extraction batch',
      agentStudioMemoryReconcileMessagesLabel: 'Messages',
      agentStudioMemoryReconcileMessagesHelp: 'How many unscanned session messages the Memory agent reads per request, each batch prefixed with one earlier message for context. Must be at least 1.',
