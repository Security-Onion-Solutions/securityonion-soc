...
const i18n = {
  translations: {
    "en-US": {
      ...
      assistantDisclaimerRequired: 'Accept the data privacy notice to use Onion AI.',
      ...
      signature: 'Signature',
      simpleAlerts: 'Simple Alerts',
      simpleAlertsAllCategories: 'All Categories',
      simpleAlertsAllSeverities: 'All Severities',
      simpleAlertsAllStatuses: 'All Statuses',
      simpleAlertsBulkSelection: '{count} selected',
      simpleAlertsBulkSelectionGroup: '{count} selected across {groups} group',
      simpleAlertsBulkSelectionGroups: '{count} selected across {groups} groups',
      simpleAlertsCategory: 'Category',
      simpleAlertsClearSelection: 'Clear',
      simpleAlertsCopied: 'Alert ID copied to the clipboard',
      simpleAlertsCopyId: 'Copy ID',
      simpleAlertsDestinationPort: 'Destination port',
      simpleAlertsDetails: 'Alert Details',
      simpleAlertsFields: 'All Fields',
      simpleAlertsGeoPrivate: 'Private network (RFC1918)',
      simpleAlertsGeoUnavailable: 'Location not available',
      simpleAlertsGroupBy: 'Group By',
      simpleAlertsGroupByNone: 'No Grouping',
      simpleAlertsGroupByRule: 'Rule',
      simpleAlertsGroupBySourceDest: 'Source and Destination',
      simpleAlertsGroupCount: '{count} alerts',
      simpleAlertsGroupEmpty: 'No alerts matched this group.',
      simpleAlertsGroupSample: 'showing first {count}',
      simpleAlertsGuidedAnalysis: 'Guided Analysis',
      simpleAlertsNetwork: 'Network',
      simpleAlertsNoAlerts: 'No alerts matched the current filters.',
      simpleAlertsNoAnswers: 'No matching events.',
      simpleAlertsNoDetection: 'No detection is associated with this alert.',
      simpleAlertsNoFields: 'This alert carries no additional fields.',
      simpleAlertsNoPlaybook: 'This detection has no playbook.',
      simpleAlertsOpenAlert: 'Open alert details',
      simpleAlertsOpenInAssistant: 'Open in Assistant',
      ...
      simpleAlertsPlaybookFailed: 'The playbook for this detection could not be loaded.',
      simpleAlertsPorts: 'Ports',
      simpleAlertsRangeDay: 'Last 24 Hours',
      ...
      simpleAlertsSelectAlert: 'Select this alert',
      simpleAlertsSelectGroup: 'Select every alert in this group',
      simpleAlertsSelectMode: 'Toggle selection mode',
      simpleAlertsSelectPair: 'Select every alert for this source and destination',
      simpleAlertsSeverityHigh: 'High',
      simpleAlertsSeverityLow: 'Low',
      simpleAlertsSeverityMedium: 'Medium',
      simpleAlertsSeverityUnknown: 'unknown',
      simpleAlertsShowAll: 'Show all {count}',
      simpleAlertsShowFewer: 'Show fewer',
      simpleAlertsSortAscending: 'Sort ascending',
      simpleAlertsSortBy: 'Sort Groups',
      simpleAlertsSortDescending: 'Sort descending',
      simpleAlertsSourcePort: 'Source port',
      simpleAlertsStatHigh: 'High Severity',
      simpleAlertsStatLow: 'Low Severity',
      simpleAlertsStatMedium: 'Medium Severity',
      simpleAlertsStatUnavailable: '—',
      simpleAlertsStatusActive: 'Active',
      simpleAlertsSubGroupBy: 'Then By',
      simpleAlertsTimeRange: 'Time Range',
      simpleAlertsTuneDetection: 'Tune Detection',
      simpleAlertsUnknownRule: 'Unknown Rule',
      skipped: 'Skipped',
