...
const i18n = {
  translations: {
    "en-US": {
      ...
      activeQueriesFilter: 'Filter out uncancellable, internal and child queries',
      add: 'Add',
      ...
      queryCancelConfirmText: 'Cancelling active queries should be avoided in most situations due to the risk of affecting the various components that interact with Elasticsearch. Would you like to continue anyway?',
      queryCancelled: 'The query cancellation has been submitted. Refresh the query list for updated results.',
      ...
      timeFrameHelp: 'Pick a start and end time. Unused for imported PCAPs.',
      ...
      ERROR_QUERY_NOT_FOUND: 'The query was not found; it likely has already completed or cancelled.',
