...
const i18n = {
  translations: {
    "en-US": {
      ...
      downloads: 'Downloads',
      downloadsFirewallTip: 'When installing the Elastic Agent onto remote systems, be sure to allow network access through the <a href="/docs/firewall.html">firewall.',
