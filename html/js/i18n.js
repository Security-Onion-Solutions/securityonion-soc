...
const i18n = {
  translations: {
    "en-US": {
      ...
      downloads: 'Downloads',
      downloadsFirewallTip: 'When installing packages such as Elastic Agent onto remote systems be sure to run <code>so-allow</code> on the Security Onion Manager node to allow network access through the firewall.',
      downloadsInfo: 'These installers are customized for this specific Elastic Fleet install. These files are not signed - signed, non-customized Elastic Agent installers can be obtained directly from <a href="https://www.elastic.co/downloads/elastic-agent">elastic.co</a>. For further Elastic Fleet information, view our online help.',
      ...
      settingsCustomized: 'Settings Modified: ',
