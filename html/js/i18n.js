...
const i18n = {
  translations: {
    "en-US": {
      ...
      esHealthBlockingReasons: 'Blocking Reasons',
      esHealthBlockingReasonsHelp: 'Allocation verdicts from explaining one sampled shard from each of the largest groups of unassigned shards (up to 5 groups).',
