...
const i18n = {
  translations: {
    "en-US": {
      ...
      ariaAbsoluteTime: 'Absolute time',
      ariaAbsoluteTimeToggle: 'Toggle to absolute time input',
      ariaAddColumn: 'Add column',
      ariaAddOverride: 'Add override',
      ariaAnalyzeInProgress: 'Analysis in progress',
      ariaAnalyzeObservable: 'Analyze observable',
      ariaAssistantDocs: 'Assistant documentation',
      ariaAssistantOptions: 'Assistant options',
      ariaAttachmentRefresh: 'Refresh attachments',
      ariaAttachmentTags: 'Attachment tags',
      ariaAttachToCase: 'Attach to case',
      ariaBarChartFor: 'Bar chart for {title}',
      ariaBreadcrumbs: 'Breadcrumbs',
      ariaBulkSelect: 'Bulk select',
      ariaBulkSelectAction: 'Bulk select action',
      ariaCancelLoading: 'Cancel loading',
      ariaCaseAttachmentTags: 'Attachment tags',
      ariaCaseComment: 'Case Comment',
      ariaCaseDescription: 'Case Description',
      ariaCaseFileAttachment: 'File Attachment',
      ariaCaseTitle: 'Case Title',
      ariaCaseToolbar: 'Case toolbar',
      ariaCaseAttachmentsToolbar: 'Attachment toolbar',
      ariaCaseEventsToolbar: 'Events toolbar',
      ariaCaseEvidenceToolbar: 'Evidence toolbar',
      ariaCaseHistoryToolbar: 'History toolbar',
      ariaChartCreditsUsage: 'Credits usage chart',
      ariaChartTotalMessages: 'Total messages chart',
      ariaNotificationsRefresh: 'Refresh notifications and schedules',
      ariaScheduleNew: 'New activation schedule',
      ariaScheduleEdit: 'Edit activation schedule',
      ariaScheduleDuplicate: 'Duplicate activation schedule',
      ariaScheduleDelete: 'Delete activation schedule',
      ariaScheduleExceptions: 'Exception schedules',
      ariaDestinationNew: 'New notification destination',
      ariaDestinationEdit: 'Edit notification destination',
      ariaDestinationDelete: 'Delete notification destination',
      ariaDestinationTest: 'Test notification destination',
      ariaDestinationSend: 'Send notification',
      ariaSendNotification: 'Send notification',
      ...
      ariaCloseWarning: 'Close warning message',
      ariaCloseTip: 'Close tip',
      ariaCloseSetting: 'Close setting',
      ariaComment: 'Comment',
      ariaCommentHours: 'Comment hours',
      ariaCommentsRefresh: 'Refresh comments',
      ariaCopy: 'Copy to clipboard',
      ariaCopyManagerMac: 'Copy manager MAC address to clipboard',
      ariaCreateJob: 'Create job',
      ariaCreateNew: 'Create new',
      ariaCreateOverride: 'Create override',
      ariaCreateUser: 'Create user',
      ariaDeleteAttachment: 'Delete attachment',
      ariaDeleteChat: 'Delete chat',
      ariaDeleteComment: 'Delete comment',
      ariaDeleteEvent: 'Delete event',
      ariaDeleteJob: 'Delete job',
      ariaDeleteObservable: 'Delete observable',
      ariaDescription: 'Description',
      ariaDetectionSignature: 'Detection signature',
      ariaDetectionStatus: 'Detection status',
      ariaEditComment: 'Edit comment',
      ariaEditInSettings: 'Edit in settings',
      ariaEventsRefresh: 'Refresh events',
      ariaExcludeErrors: 'Exclude decode failures',
      ariaExpandAttachment: 'Expand attachment',
      ariaExpandClient: 'Expand client',
      ariaExpandEvent: 'Expand event',
      ariaExpandGraphs: 'Expand graphs',
      ariaExpandGroup: 'Expand group',
      ariaExpandHistory: 'Expand history',
      ariaExpandHistoryOverride: 'Expand override history',
      ariaExpandNav: 'Expand navigation',
      ariaExpandNode: 'Expand grid node',
      ariaExpandObservable: 'Expand observable',
      ariaExpandOverride: 'Expand override',
      ariaExpandTable: 'Expand table',
      ariaExpandUser: 'Expand user',
      ariaExportCase: 'Export case',
      ariaExportEvents: 'Export events',
      ariaExportSession: 'Export session',
      ariaFilterToggles: 'Filter toggles',
      ariaGridRefresh: 'Refresh grid',
      ariaGridTimezone: 'Grid timezone',
      ariaGridUploadFile: 'Upload file for import',
      ariaGroupBy: 'Group by this field',
      ariaHelpLink: 'Documentation link',
      ariaHex: 'Show as hex',
      ariaHistoryRefresh: 'Refresh history',
      ariaIncognitoOff: 'Incognito off; this session may be used to create memories',
      ariaIncognitoOn: 'Incognito on; this session will not be used to create memories',
      ariaHunt: 'Hunt',
      ariaHuntForError: 'Hunt for error',
      ariaHuntForObservable: 'Hunt for observable',
      ariaHuntQuery: 'Hunt query',
      ariaHuntQuestion: 'Hunt this question',
      ariaIoc: 'IOC',
      ariaInspectField: 'Inspect field value',
      ariaJobsHelp: 'View documentation for jobs',
      ...
      ariaMd5Copy: 'Copy MD5 hash to clipboard',
      ariaMessageAi: 'Message AI',
      ariaMoveEntryUp: 'Move entry up',
      ariaMoveEntryDown: 'Move entry down',
      ariaNodeImageFront: 'Front image of appliance',
      ariaNodeImageBack: 'Back image of appliance',
      ariaOtpInput: 'One-time password input',
      ariaOverrideDelete: 'Delete Override',
      ariaOverrideStatus: 'Override status',
      ariaPacketDisplayOptions: 'Packet display options',
      ariaPacketStream: 'Show as packet stream',
      ariaPickerEndAmPm: 'End time AM/PM',
      ariaPickerEndHour: 'End time hour',
      ariaPickerEndMinute: 'End time minute',
      ariaPickerEndSecond: 'End time second',
      ariaPickerStartAmPm: 'Start time AM/PM',
      ariaPickerStartHour: 'Start time hour',
      ...
      ariaRelativeTimeUnits: 'Relative time units',
      ariaReloadData: 'Reload data',
      ...
      ariaSettingsToolbar: 'Settings toolbar',
      ariaSha1AddObservable: 'Add Sha-1 hash as observable',
      ariaSha1Copy: 'Copy Sha-1 hash to clipboard',
      ariaSha256AddObservable: 'Add Sha-256 hash as observable',
      ariaSha256Copy: 'Copy Sha-256 hash to clipboard',
      ariaShowDateRangePicker: 'Open date range picker',
      ariaShowModified: 'Show modified settings',
      ariaStatus: 'Status: {status}',
      ariaSuricataVars: 'Configure Suricata variables',
      ariaSwitchToHunt: 'Switch to Hunt',
      ariaTags: 'Tags',
      ariaToggleFullQuery: 'Toggle Full Query',
      ariaTotpCode: 'TOTP code',
      ariaTotpQr: 'TOTP QR code',
      ariaUnlinkFromCase: 'Unlink from case',
      ariaUnlinkSecurityKey: 'Unlink security key',
      ariaUpperBoundOperator: 'Upper bound operator',
      ariaUserSettings: 'User settings',
      ariaVisitConfigEntry: 'Visit configuration entry',
      ...
      activeQueriesCount: 'Active Queries:',
      activeQueriesFilter: 'Filter out uncancelable, internal and child queries',
      add: 'Add',
      ...
      addCaseCommentHelp: 'Add a new comment to this case',
      addDetectionCommentHelp: 'Add a new comment to this detection',
      ...
      aiInvestigated: 'Investigated',
      aiInvestigateView: 'View Investigation',
      aiInvestigate: 'Investigate',
      aiInvestigateMostRecent: 'Investigate most recent',
      aiInvestigationCompleted: 'AI Investigation completed for alert',
      aiInvestigationCouldNotLoad: 'Failed to load investigation sessions',
      aiInvestigationFailed: 'AI Investigation failed',
      aiInvestigationResults: 'AI Investigation Results',
      aiInvestigationStarting: 'Start AI Investigation',
      aiInvestigationUnableToFetchNewest: 'Unable to fetch most recent alert in group',
      aiInvestigationUnableToIdentify: 'Unable to identify alert for investigation',
      aiAssessment: 'AI Assessment',
      aiConfidence: 'Confidence',
      aiAnalysis: 'Analysis',
      aiInvestigationCompletedAt: 'Investigation completed',
      ...
      agentStudioIdentity: 'Identity',
      agentStudioDelegation: 'Delegation',
      agentStudioOrchestrator: 'Orchestrator',
      agentStudioScanHistoryTitle: 'Scan historic AI conversations?',
      agentStudioScanHistoryBody: 'Selecting Yes will utilize manager CPU resources as it catches up, and may consume AI tokens/credits unless using local models. Choosing No will only scan new conversations beginning today. It will still be possible to come back later and toggle this off and back on, and then select Yes to scan historic conversations.',
      agentStudioSpecialist: 'Specialist',
      agentStudioModel: 'Model',
      agentStudioExecutingModel: 'Executing Model',
      agentStudioProvider: 'Provider',
      agentStudioProviderHelp: 'The adapter that serves this agent\'s model.',
      agentStudioName: 'Name',
      agentStudioRole: 'Role',
      agentStudioDescription: 'Description',
      agentStudioDescriptionHelp: 'Shown to other agents to help them decide when to delegate to this agent.',
      agentStudioUsedBy: 'Used By',
      agentStudioExpand: 'Toggle details',
      agentStudioDelegatesTo: 'Delegates To',
      agentStudioSkillsHelp: 'Each skill grants this agent a bundle of tools and prompt guidance.',
      agentStudioDelegationHelp: 'Other agents this agent can delegate work to.',
      agentStudioDelegators: 'Delegators',
      agentStudioDelegatorsHelp: 'Other agents that can delegate work to this agent.',
      agentStudioDelegatorsFailed: 'The agent was created, but delegation could not be granted to:',
      agentStudioModelHelp: 'The model this agent runs on.',
      agentStudioToolsUnlockedHelp: 'Tools this skill unlocks for the agents that hold it.',
      agentStudioUsedByHelp: 'Agents currently granted this skill.',
      agentStudioEnabled: 'Enabled',
      agentStudioNewAgent: 'New Agent',
      ...
      agentStudioSystemSkillsNote: 'The skills of a system agent are fixed.',
      agentStudioSystemToolsNote: 'The tools of a system skill are fixed.',
      agentStudioPersona: 'Persona',
      agentStudioPersonaAddendum: 'Persona Addendum',
      agentStudioPersonaHelp: 'Defines the behavior, tone, and instructions to follow.',
      agentStudioSkillPersonaHelp: 'Guidance added to the prompt of every agent granted this skill.',
      agentStudioPromptGuidance: 'Prompt Guidance',
      agentStudioSystemPersonaNote: 'This system agent has built-in instructions that cannot be viewed or edited. Anything entered here is appended to them.',
      agentStudioSystemSkillPersonaNote: 'This system skill has built-in guidance that cannot be viewed or edited. Anything entered here is appended to it.',
      agentStudioMemories: 'Memory',
      agentStudioNewMemory: 'New Memory',
      agentStudioMemoryText: 'Memory',
      agentStudioMemoryTextHelp: 'A single standalone fact, written the way the assistant should recall it.',
      agentStudioMemoryScope: 'Scope',
      agentStudioMemoryScopeUser: 'User',
      agentStudioMemoryScopeGlobal: 'Global',
      agentStudioMemoryScopeHelp: 'A user memory is recalled only for its owner; a global memory is recalled for everyone.',
      agentStudioMemoryOrigin: 'Origin',
      agentStudioMemoryOriginHelp: 'The conversation this memory was extracted from.',
      agentStudioMemoryRecalled: 'Recalled',
      agentStudioMemoryRecalledHelp: 'How many times this memory has been added to a prompt.',
      agentStudioMemoryLastRecalled: 'Last Recalled',
      agentStudioMemoryNeverRecalled: 'Never',
      agentStudioMemoryUserDefined: 'User-defined',
      agentStudioMemoryUserDefinedHelp: 'User-defined memories are never rewritten or removed by the memory scanner.',
      agentStudioMemoryScanned: 'Created by the memory scanner, which may still rewrite or remove it. Saving a change here makes it user-defined, and the scanner will leave it alone.',
      agentStudioMemorySearchHelp: 'Finds memories by meaning rather than by wording, and only reaches memories embedded by the current embedding model.',
      agentStudioMemoryTextRequired: 'Enter the text of the memory.',
      agentStudioMemoriesEmpty: 'No memories stored yet.',
      agentStudioMemoryStale: 'memories are being re-embedded after an embedding model change. They cannot be recalled or searched until that finishes.',
      agentStudioMemoryDisabled: 'Assistant memory is disabled.',
      agentStudioMaxDepth: 'Max delegation depth',
      agentStudioMaxSubTokens: 'Max sub-session tokens',
      agentStudioOptionsHelp: 'Global guardrails applied to all agentic delegation. A value of 0 disables the limit.',
      agentStudioMemoryUse: 'Memory system',
      agentStudioMemoryUseHelp: 'Include relevant memories in the prompt when a user sends a message.',
      agentStudioMemoryScanner: 'Memory scanner',
      agentStudioMemoryScannerHelp: 'Automatically extract memories from sessions in the background.',
      agentStudioMemoryScanInterval: 'Scan interval',
      agentStudioMemoryScanIntervalHelp: 'How long to wait between attempts to scan sessions for new memories.',
      agentStudioMemoryProximity: 'Memory proximity',
      agentStudioMessageProximity: 'Message proximity',
      ...
      agentStudioMemoryRoleDisabled: 'Not configured or enabled; role disabled.',
      agentStudioMemoryPersonas: 'Persona Addenda',
      agentStudioMemoryPersonaSet: 'Has unsaved changes.',
      agentStudioMemoryPersonaHelp: 'Appended to the built-in prompt that decides what is worth remembering.',
      agentStudioReconcilePersonaHelp: 'Appended to the built-in prompt that decides how a new memory is merged with existing ones.',
      agentStudioMemoryIncludeLimits: 'Memories to include',
      agentStudioMemoryReconcileLimits: 'Memories to reconcile',
      agentStudioMemoryLimitsHelp: 'The maximum user-specific and global memories to include in a prompt, and to consider when reconciling a new memory. A value of 0 disables that scope.',
      agentStudioMemoryExtractBatchSize: 'Messages per extraction batch',
      agentStudioMemoryExtractBatchSizeLabel: 'Messages',
      agentStudioMemoryExtractBatchSizeHelp: 'How many unscanned session messages the Memory agent reads per request, each batch prefixed with one earlier message for context. Must be at least 1.',
      agentStudioMemoryMaxRetries: 'Memory scan retries',
      agentStudioMemoryMaxRetriesLabel: 'Retries',
      agentStudioMemoryMaxRetriesHelp: 'How many times a failed memory scan of a session is retried.',
      agentUser: 'Agent',
      analyze: 'Analyze',
      ...
      assistantIncognitoSession: 'Incognito Session',
      assistantIncognitoTitle: 'Toggle incognito: an incognito session is never used to create memories. Locked once the first message is sent.',
      ...
      assistantUnableToInvestigate: 'Failed to send investigation message',
      assistantUnableToLoadChat: 'Failed to load chat',
      assistantUnableToLoadCredits: 'Error loading credits from API',
      assistantUnableToLoadHistory: 'Failed to load chat history from backend',
      ...
      clientCredentialsReminder: 'Note that new API clients have no permissions; in the underlying screen choose the permissions desired for this API client.',
      ...
      clientDeleted: 'API client removed',
      clientId: 'Client ID',
      clientNameRequired: 'API client name is required',
      clientPermissionAdded: 'Permission added to API client',
      clientPermissionDeleted: 'Permission removed from API client',
      clientSecret: 'Client Secret',
      clientSecretGenerated: 'A new secret has been generated for the API client.',
      clientSecretHelp: 'This client secret is only temporarily viewable.',
      clientUpdated: 'API client updated',
      clients: 'API Clients',
      ...
      configQLFirewallSensor: 'Allow Sensor Nodes to connect to Manager',
      configQLNIDSHeader: 'NIDS',
      configQLNIDSRuleset: 'Configure NIDS Rulesets',
      ...
      contextStartsHere: 'Context Starts Here',
      contextualDocsBtn: 'Open related documentation',
      ...
      csv: 'CSV',
      currentAgentAndModel: 'Current Agent and Model',
      ...
      days: 'days',
      dDays: 'd',
      decodeFailuresExcludedNotice: 'Packet decode failures are currently excluded from this view. Disable the exclude filter to view all packets.',
      decodeFailuresPresentNotice: 'This capture contains packet decode failure(s). Click the exclude filter in the toolbar to omit them.',
      defaults: 'Defaults',
      delete: 'Delete',
      deleteSuccessful: 'Deleted successfully',
      deleted: 'Deleted',
      deleteClientConfirm: 'You are about to permanently delete this client:',
      deleteClientTitle: 'Delete API Client',
      ...
      detectionsData: 'Detections Data',
      ...
      detectionConfirmDeleteHelp: 'Deleting a detection is permanent and there is no undo for this operation. Consider disabling this detection, if it may be needed at a later time.<br><br>Proceed and delete this detection?',
      ...
      detectionEngineImportPendingHelp: 'Rule import is pending and will begin soon.',
      detectionEngineImporting: 'Importing',
      detectionEngineImportingHelp: 'Importing rules occurs once, to convert all rules from the old Playbook system to the new Detections module.',
      detectionEngineIntegrityFailure: 'Rule Mismatch',
      detectionEngineIntegrityFailureHelp: 'Click to hunt for SOC logs that might provide more information about the mismatch.',
      detectionEngineMigrating: 'Migrating',
      detectionEngineMigratingHelp: 'Rule migration takes place after upgrading Security Onion to a new version.',
      detectionEngineMigrationFailure: 'Migration Failed',
      detectionEngineMigrationFailureHelp: 'Rule migration aborted due to errors. Click to hunt for related SOC logs.',
      detectionEngineSyncFailure: 'Sync Failed',
      detectionEngineSyncFailureHelp: 'Errors occurred during the most recent rule sync. Click to hunt for related SOC logs.',
      detectionEngineBlocked: 'Sync Blocked',
      detectionEngineBlockedHelp: 'Rule synchronization is currently blocked.',
      detectionEngineSyncing: 'Synchronizing',
      detectionEngineSyncingHelp: 'Rules synchronize periodically to ensure the latest rulesets are applied to this grid.',
      detectionEngineUnknown: 'Pending',
      detectionEngineUnknownHelp: 'A status update should be provided by the SOC server momentarily',
      detectionId: 'Detection Id',
      detectionLogic: 'Detection Logic',
      detectionPlaybooksAi: "Some playbooks were generated by AI and it's possible that they may not be 100% accurate. Please let us know if you see any issues.",
      ...
      displayed: 'displayed',
      displayInfo: 'display info {display_state}',
      download: 'Download',
      downloads: 'Downloads',
      ...
      excludeErrorsHelp: 'Exclude packet decode failures from view',
      error: 'Error',
      errorSingular: 'error',
      errorPlural: 'errors',
      ...
      eventsHealthAffectedIndices: 'Affected indices',
      eventsHealthAffectedNodes: 'Affected nodes',
      eventsHealthConditionDiskThreshold: 'Nodes are above a disk usage watermark; free up or expand storage on the affected nodes.',
      eventsHealthConditionIndicesReadonly: 'Write-blocked (read-only) indices: {count}. Writes to these indices are rejected; Elasticsearch typically applies this block when disk usage exceeds the flood stage watermark.',
      eventsHealthConditionNoValidShardCopy: 'No copy of these shards exists on any node in the cluster; their data is unavailable until a node holding a copy rejoins the grid.',
      eventsHealthConditionSameShard: 'Replica shards cannot be placed on the same node as their primary; this is expected when the grid has a single search node.',
      eventsHealthConditionThrottling: 'Shard recovery is temporarily throttled; this usually resolves on its own as recoveries complete.',
      eventsHealthConditionUnexplained: 'Elasticsearch reports no blocking deciders for this group; allocation outcome: {value}.',
      eventsHealthCopied: 'Copied Elasticsearch health report to clipboard.',
      eventsHealthCopyReport: 'Copy Report',
      eventsHealthFindings: 'Findings',
      eventsHealthFindingsShardHelp: 'Allocation verdicts from explaining one sampled shard from each of the largest groups of unassigned shards (up to 5 groups).',
      eventsHealthHealthy: 'Healthy',
      eventsHealthIssues: 'Issues',
      eventsHealthLessDetails: 'Hide details',
      eventsHealthMoreDetails: 'More details',
      eventsHealthMoreItems: ', ... (+{count} more)',
      eventsHealthNoIssues: 'No issues detected. All Elasticsearch health indicators are green.',
      eventsHealthPrimary: 'primary',
      eventsHealthReplica: 'replica',
      eventsHealthReportCanAllocate: 'Can allocate',
      eventsHealthReportFailureDetails: 'Failure details',
      eventsHealthReportGenerated: 'Generated',
      eventsHealthReportNoSample: 'No allocation explanation sampled for {value}',
      eventsHealthReportNone: '(none)',
      eventsHealthReportSampledShard: 'Sampled shard for {value}:',
      eventsHealthReportSampleFailed: 'Allocation explanation could not be retrieved for {value}',
      eventsHealthReportSectionIndicators: '--- Indicators (_health_report) ---',
      eventsHealthReportSectionNodes: '--- Nodes (_cat/nodes) ---',
      eventsHealthReportSectionSettings: '--- Cluster Settings (_cluster/settings) ---',
      eventsHealthReportSectionShards: '--- Unassigned Shards (_cat/shards, _cluster/allocation/explain) ---',
      eventsHealthReportShard: 'Shard',
      eventsHealthReportSince: ', since {value}',
      eventsHealthReportStatus: 'Overall status',
      eventsHealthReportTitle: 'ELASTICSEARCH HEALTH REPORT',
      eventsHealthReportTotals: 'Total: {total} unassigned ({primaries} primary, {replicas} replica)',
      eventsHealthReportUnassignedReason: 'Unassigned reason',
      ...
      expired: 'Expired',
      exportCase: 'Export Case Report',
      exportCaseHelp: 'Export this case as a PDF report',
      ...
      'field_so_detection.category': 'Category',
      'field_so_detection.product': 'Logsource - Product',
      'field_so_detection.service': 'Logsource - Service',
      'field_so_detection.overrides.type': 'Override Type',
      field_count: 'Count',
      ...
      groupNumeric: "New Numeric Group By",
      groups: 'Group Metrics',
      guidedAnalysis: 'Guided Analysis',
      help: 'Help',
      hex: 'HEX',
      ...
      hours: 'hours',
      hunt: 'Hunt',
      huntForCase: "Hunt for this case's events",
      ...
      invalid: 'Invalid',
      invalidDetectionElastAlertMissingDetectionLogic: `This Sigma rule is missing its detection logic. A "detection" field is required.`,
      ...
      message: 'Message',
      metrics: 'Metrics',
      metricsConsumptionEps: 'Consumption EPS',
      ...
      metricsLast15Minutes: 'Last 15 Minutes',
      metricsLast24Hours: 'Last 24 Hours',
      metricsLast2Days: 'Last 2 Days',
      metricsLast30Days: 'Last 30 Days',
      metricsLast3Hours: 'Last 3 Hours',
      metricsLast5Minutes: 'Last 5 Minutes',
      metricsLast6Hours: 'Last 6 Hours',
      metricsLast7Days: 'Last 7 Days',
      metricsLastHour: 'Last Hour',
      metricsLastMinute: 'Last Minute',
      metricsLoad1: 'Load 1m',
      metricsLoad15: 'Load 15m',
      metricsLoad5: 'Load 5m',
      metricsMemUsage: 'Memory Usage',
      metricsNetTraffic: 'Network Traffic',
      metricsNode: 'Node',
      metricsNodeDashboard: 'Performance Graphs',
      metricsNodes: 'Nodes',
      metricsProductionEps: 'Production EPS',
      metricsRefreshInterval: 'Refresh Interval',
      metricsTimeRange: 'Time Range',
      metricsTrafficManIn: 'Management In',
      metricsTrafficManOut: 'Management Out',
      metricsTrafficMonIn: 'Monitoring In',
      metricsSystemUptime: 'System Uptime',
      metricsIoWait: 'IO Wait',
      metricsPcapRetention: 'PCAP Retention',
      metricsElasticsearchSize: 'Elasticsearch Storage Size',
      metricsElasticsearchDocs: 'Elasticsearch Document Count',
      metricsElasticIngestTime: 'Elastic Ingest Time Spent',
      metricsSuricataLoss: 'Suricata Packet Loss',
      metricsZeekLoss: 'Zeek Packet Loss',
      metricsCaptureLoss: 'Zeek Capture Loss',
      metricsKafkaEps: 'Kafka EPS',
      metricsKafkaControllers: 'Kafka Active Controllers',
      metricsKafkaBrokers: 'Kafka Active Brokers',
      metricsKafkaUnderReplicated: 'Kafka Under Replicated Partitions',
      metricsContainerUptime: 'Container Uptime',
      metricsContainerCpu: 'Container CPU Usage',
      metricsContainerMem: 'Container Memory Usage',
      metricsContainerNetIn: 'Container Traffic - Inbound',
      metricsRedisQueue: 'Redis Queue',
      metricsLogstashEps: 'Logstash Events Received',
      metricsEventsReceived: 'Events Received',
      metricsLoadAverage: 'System Load Average',
      metricsMonitorDrops: 'Monitor Interface Drops - Inbound',
      metricsDocsCount: 'Docs Count',
      metricsStorageSize: 'Storage Size',
      metricsUptimeDays: 'Uptime (Days)',
      metricsTimeMs: 'Time (ms)',
      metricsDropRatePct: 'Drop Rate %',
      metricsQueueSize: 'Queue Size',
      metricsControllers: 'Controllers',
      metricsBrokers: 'Brokers',
      metricsPartitions: 'Partitions',
      ...
      metricsLoss: 'Loss',
      metricsDrops: 'Drops',
      metricsRetentionDays: 'Retention (Days)',
      minutes: 'minutes',
      ...
      deleteDestinationConfirm: 'Are you sure you want to delete this notification destination?',
      deleteDestinationWarning: 'Notifications will no longer be dispatched to this destination.',
      destinationType: 'Channel Type',
      channelType: 'Channel Type',
      channel: 'Channel',
      enableRecipients: 'Recipient Targeting',
      enableRecipientsHint: 'When enabled, targeted notifications are delivered specifically to designated user recipients instead of being broadcast globally.',
      skipIfRecipients: 'Skip Targeted Notifications',
      skipIfRecipientsHint: 'When enabled, notifications targeted to specific recipients will be skipped for this destination.',
      builtinSOCNotifications: 'Built-in SOC Notifications',
      severities: 'Severities',
      limitSeverities: 'Filter by Severities',
      allSeverities: 'All Severities',
      severitiesHint: 'Select specific severities to receive. Leave empty to allow all severities.',
      severitiesPlaceholder: 'All severities (unrestricted)',
      ...
      activationScheduleHint: 'Optionally link an activation schedule to control when notifications are dispatched to this destination.',
      activationSchedulePlaceholder: 'None (Always Active)',
      noScheduleAlwaysActive: 'None (Always Active)',
      testConnection: 'Test Connection',
      testDestination: 'Test Destination',
      testSend: 'Test Send',
      testSendTargeted: 'Test Send (Targeted)',
      testNotificationTitle: 'Test: {name}',
      testTargetedNotificationTitle: 'Test (Targeted): {name}',
      testNotificationSummary: 'This is a test notification summary.',
      testTargetedNotificationSummary: 'This is a targeted test notification dispatched to verify recipient destination connectivity.',
      testNotificationDefaultTitle: 'Test Notification',
      testNotificationBypassHint: 'This notification will bypass assigned schedule(s).',
      testNotificationSent: 'Test notification sent successfully!',
      testTargetedNotificationSent: 'Targeted test notification sent successfully!',
      testNotificationFailed: 'Test notification failed to deliver.',
      send: 'Send',
      sendNotification: 'Send Notification',
      sendDestinationNotification: 'Send Notification to {name}',
      recipients: 'Recipients',
      allUsersPlaceholder: 'All users (sent to everyone)',
      ...
      activationSchedules: 'Activation Schedules',
      schedules: 'Schedules',
      schedule: 'Schedule',
      ...
      exceptionSchedulesPlaceholder: 'Select exception / blackout schedules...',
      noExceptionSchedulesAvailable: 'No eligible exception schedules available',
      exceptionsPrefix: 'Exceptions',
      ...
      detectBrowserTimezone: 'Detect Browser Timezone',
      destinationsPlaceholder: 'Notification destinations administration will be available here.',
      daySunday: 'Sunday',
      dayMonday: 'Monday',
      dayTuesday: 'Tuesday',
      ...
      playbookNone: 'No Playbooks are loaded for this detection.',
      playbooks: 'Playbooks',
      playbooksAi: "Guided Analysis is a new experimental feature. Some of these playbooks were generated by AI and it's possible that they may not be 100% accurate. Please let us know if you see any issues.",
      ...
      detectionSyncBlockedErr: 'Unable to save detection: rule synchronization is currently blocked due to manual intervention required after recent upgrade.',
      ...
      queryCancelConfirm: 'Cancel Query',
      ...
      refreshCaseCommentsHelp: 'Refresh to view all recently added comments for this case.',
      refreshDetectionCommentsHelp: 'Refresh to view all recently added comments for this detection.',
      ...
      requestCanceled: 'The request was canceled by user.',
      required: 'Required.',
      ...
      searchUsernameHelp: 'Optional Elastic username to "run-as" when submitting Elastic requests.',
      seconds: 'seconds',
      ...
      selectAll: 'Select All {count} Detections',
      ...
      settingChangeInProgress: 'A setting was being edited while the configuration was reloaded. That setting value, including any changes from the saved value, will remain visible to avoid loss of work. Be aware that if the selected grid has just changed and the setting is saved it will apply that setting value to the newly selected grid.',
      ...
      settingNoteTitle: 'Configuration Change',
      ...
      settingHistory: 'Show setting history',
      settingHistoryTitle: 'History',
      settingHistoryGlobal: 'Audit History',
      settingHistoryNext: 'Next',
      settingHistoryPrev: 'Previous',
      settingHistoryPage: 'Page',
      settingHistoryTotal: 'Total',
      settingHistoryError: 'Failed to retrieve configuration history.',
      settingHistoryFilter: 'Filter history',
      settingHistoryFilterApply: 'Apply filter',
      settingHistoryFilterNoMatch: 'No matching history entries found.',
      settingHistoryFiltered: 'Showing',
      settingHistoryFirst: 'First Page',
      settingHistoryLast: 'Last Page',
      settingRevert: 'Revert This Change',
      settingRevertTitle: 'Confirm Revert',
      settingRevertHelp: 'Are you sure you want to revert this setting to the value prior to {timestamp}?',
      settingRevertNoteDefault: 'Reverting setting to state prior to {timestamp}',
      settingRevertNoteDefaultAll: 'Reverting all settings to state prior to {timestamp}',
      settingRevertAll: 'Revert all settings to this point in time',
      settingRevertAllTitle: 'Confirm Global Revert',
      settingRevertAllHelp: 'This will revert ALL settings in the grid back to their state prior to {timestamp}.',
      settingRevertAllAffected: 'This will affect {count} settings.',
      settingRevertAllConfirm: 'To confirm, type the number {count} into the field below.',
      settingRevertError: 'Failed to revert configuration.',
      settingRevertHelpSingle: 'Are you sure you want to revert the selected setting to its previous value of "{value}"?',
      settingRevertHelpSingleNull: 'Are you sure you want to revert the selected setting and remove its custom value?',
      settingRevertNullValue: 'This setting will have its custom value removed.',
      settingRevertValueInfo: 'The previous value was: {value}',
      settingReverted: 'Configuration reverted successfully.',
      settingRevertNoChange: 'The old value is the same as the new value; nothing to revert.',
      settingTime: 'Time',
      settingUser: 'User',
      settingNote: 'Note',
      settingIdLabel: 'Setting ID',
      settingNodeLabel: 'Node',
      settingNoNotes: 'No notes provided.',
      settingOldValueLabel: 'Old Value',
      settingGoToSetting: 'Go to setting',
      settingIncomplete: 'This setting entry is incomplete or invalid. Ensure all required fields have been populated with valid values.',
      ...
      settingNoHistory: 'No history available for this setting.',
      settingOldValue: 'Old Value',
      settingNewValue: 'New Value',
      ...
      'so-eval': 'Evaluation',
      'so-eval-keywords': 'Elastic, Elasticsearch, Fleet, Forward, Ingest, Manager, Master, Search, Sensor, Sensoroni, Soc, Suricata, Web',
      'so-fleet': 'Fleet',
      'so-fleet-keywords': 'Fleet',
      'so-heavynode': 'Heavy',
      'so-heavynode-keywords': 'Elastic, Elasticsearch, Forward, Ingest, Search, Sensor, Sensoroni, Suricata',
      'so-helix': 'Helix',
      'so-helix-keywords': 'Helix, Sensor, Sensoroni, Suricata',
      'so-hypervisor': 'Hypervisor',
      'so-hypervisor-keywords': 'Hypervisor, Virtualization, VM, KVM, Vx',
      ...
      'so-sensor': 'Sensor',
      'so-sensor-keywords': 'Forward, Sensor, Sensoroni, Suricata',
      'so-standalone': 'Standalone',
      'so-standalone-keywords': 'Elastic, Elasticsearch, Fleet, Forward, Ingest, Manager, Master, Search, Sensor, Sensoroni, Soc, Suricata, Web',
      ...
      timeFrameHelp: 'Pick a start and end time (local time). Unused for imported PCAPs.',
      timeFrameReportsHelp: 'Pick a start and end time (local time), or leave blank to include all data.',
      ...
      toolExecuteQuestion: 'This tool wants to execute. Do you approve?',
      ...
      ybps: 'Yb/s',
      you: 'You',
      suriRulesLoaded: 'Suricata Rules',
      suriRulesReloadTime: 'Last Suricata Reload',
      rulesLoaded: 'loaded',
      rulesFailed: 'failed',
      rulesNoneLoaded: 'none loaded',
      rulesNoRulesConfigured: 'no rules configured',
      rulesUnknown: 'unknown',
      rulesAllFailed: 'all rules failed',
      zbps: 'Zb/s',
      zeekLoss: 'Zeek Loss',
      ...
      ERROR_LICENSE_INVALID: 'Security Onion Pro license is required for this operation',
      ...
      ERROR_QUERY_NOT_FOUND: 'The query was not found; it likely has already completed or canceled.',
