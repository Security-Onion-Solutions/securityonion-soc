...
const i18n = {
  translations: {
    "en-US": {
      ...
      exportEventsHelp: 'Export the events as a CSV file',
      exportJobEnqueued: 'A new exported report job has been enqueued and will be available for download via the <a id="view-export-results" class="text-white" href="/#/reports">report page</a> when complete.',
      extract: 'Extract',
      ...
      reports: 'Reports',
      reporting: 'Reporting',
      reportProductivity: 'Productivity',
