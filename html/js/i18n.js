...
const i18n = {
  translations: {
    "en-US": {
      ...
      configQLFirewallFleet: 'Allow access to Elastic Fleet Nodes',
      configQLFirewallIDH: 'Allow access to IDH Nodes',
      configQLFirewallReceiver: 'Allow access to Receiver Nodes',
      configQLFirewallSearch: 'Allow access to Search Nodes',
      configQLFirewallSensor: 'Allow access to Sensors (Forward Nodes)',
      ...
      gridMemberUploadTitle: 'Upload a PCAP or EVTX File',
