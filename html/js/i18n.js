...
const i18n = {
  translations: {
    "en-US": {
      ...
      esHealthAffectedIndices: 'Affected indices',
      esHealthAffectedNodes: 'Affected nodes',
      esHealthCopied: 'Copied Elasticsearch health report to clipboard.',
      esHealthCopyReport: 'Copy Report',
      esHealthDiskReadonly: 'Write-blocked (read-only) indices: {count}. Writes to these indices are rejected; Elasticsearch typically applies this block when disk usage exceeds the flood stage watermark.',
      esHealthFindings: 'Findings',
      esHealthFindingsShardHelp: 'Allocation verdicts from explaining one sampled shard from each of the largest groups of unassigned shards (up to 5 groups).',
      esHealthHealthy: 'Healthy',
      esHealthIssues: 'Issues',
      esHealthLessDetails: 'Hide details',
      esHealthMoreDetails: 'More details',
      esHealthMoreItems: ', ... (+{count} more)',
      esHealthNoIssues: 'No issues detected. All Elasticsearch health indicators are green.',
      esHealthPrimary: 'primary',
      esHealthReplica: 'replica',
      esHealthReportCanAllocate: 'Can allocate',
      esHealthReportDetails: 'Failure details',
      esHealthReportGenerated: 'Generated',
      esHealthReportNoSample: 'No allocation explanation sampled for {value}',
      esHealthReportNone: '(none)',
      esHealthReportSampledShard: 'Sampled shard for {value}:',
      esHealthReportSampleFailed: 'Allocation explanation could not be retrieved for {value}',
      esHealthReportSectionIndicators: '--- Indicators (_health_report) ---',
      esHealthReportSectionNodes: '--- Nodes (_cat/nodes) ---',
      esHealthReportSectionSettings: '--- Cluster Settings (_cluster/settings) ---',
      esHealthReportSectionShards: '--- Unassigned Shards (_cat/shards, _cluster/allocation/explain) ---',
      esHealthReportShard: 'Shard',
      esHealthReportSince: ', since {value}',
      esHealthReportStatus: 'Overall status',
      esHealthReportTitle: 'ELASTICSEARCH HEALTH REPORT',
      esHealthReportTotals: 'Total: {total} unassigned ({primaries} primary, {replicas} replica)',
      esHealthReportUnassignedReason: 'Unassigned reason',
      esHealthReportUnavailable: 'Collection failed: {value}',
      esHealthShow: 'View Elasticsearch cluster health details',
      esHealthTitle: 'Elasticsearch Health',
      esHealthUnavailable: 'Elasticsearch health information is currently unavailable.',
      esHealthVerdictDiskThreshold: 'Nodes are above a disk usage watermark; free up or expand storage on the affected nodes.',
      esHealthVerdictNoValidShardCopy: 'No copy of these shards exists on any node in the cluster; their data is unavailable until a node holding a copy rejoins the grid.',
      esHealthVerdictSameShard: 'Replica shards cannot be placed on the same node as their primary; this is expected when the grid has a single search node.',
      esHealthVerdictThrottling: 'Shard recovery is temporarily throttled; this usually resolves on its own as recoveries complete.',
      esHealthVerdictUnexplained: 'Elasticsearch reports no blocking deciders for this group; allocation outcome: {value}.',
      event: 'Event',
      events: 'Events',
