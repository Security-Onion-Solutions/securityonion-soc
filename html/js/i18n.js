...
const i18n = {
  translations: {
    "en-US": {
      ...
      downloads: 'Downloads',
      downloadsFirewallTip: 'When installing packages such as Elastic Agent onto remote systems be sure to allow network access through the <a href="/docs/firewall.html">firewall.',
      downloadsInfo: 'These <a href="/docs/elastic-agent.html">Elastic Agent installers are customized for this specific <a href="/docs/elastic-fleet.html">Elastic Fleet installation. These files are not signed. If you need signed, non-customized Elastic Agent installers, you can get them from <a href="https://www.elastic.co/downloads/elastic-agent">elastic.co</a>.',
