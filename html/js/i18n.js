...
const i18n = {
  translations: {
    "en-US": {
      ...
      gridMemberTestConfirmHelp: "Testing this grid sensor will cause test data to be ingested into Security Onion. This can be useful for validating proper sensor operation. Test data will remain loaded until the index is curated. Do you want to continue?",
      gridMemberTestSuccess: "Test data is being ingested. This may take a few minutes depending on grid resources.",
      groupedBy: 'Group:',
