...
return a}function Tr(e){return{items:t.computed(()=>Dr(e,e.items))}}const Br=rt({baseColor:String,activeColor:String,activeClass:String,bgColor:String,disabled:Boolean,filterable:Boolean,expandIcon:_t,collapseIcon:_t,lines:{type:[Boolean,String],default:"one"},slim:Boolean,prependGap:[Number,String],indent:[Number,String],nav:Boolean,navigationStrategy:{type:String,default:"focus"},navigationIndex:Number,"onClick:open":Y(),"onClick:select":Y(),"onUpdate:opened":Y(),...dr({selectStrategy:"single-leaf",openStrategy:"list"}),...hl(),...it(),...Al(),...el(),...bl(),...Cr(),...sl(),...xa(),...va(),...Fl({variant:"text"})},"VList"),Fr=ft()({name:"VList",props:Br(),emits:{"update:selected":e=>!0,"update:activated":e=>!0,"update:opened":e=>!0,"update:navigationIndex":e=>!0,"click:open":e=>!0,"click:activate":e=>!0,"click:select":e=>!0},setup(e,{attrs:a,slots:l,emit:n}){const{items:o}=Tr(e),{themeClasses:r}=Va(e),{backgroundColorClasses:i,backgroundColorStyles:s}=rl(()=>e.bgColor),{borderClasses:u}=yl(e),{densityClasses:c}=Dl(e),{dimensionStyles:d}=tl(e),{elevationClasses:v}=Vl(e),{roundedClasses:p}=ul(e),{children:m,open:g,parents:h,select:y,getPath:b}=vr(e,{items:o,returnObject:t.toRef(()=>e.returnObject),scrollToActive:t.toRef(()=>"track"===e.navigationStrategy)}),V=t.toRef(()=>e.lines?`v-list--${e.lines}-line`:void 0),w=t.toRef(()=>e.activeColor),S=t.toRef(()=>e.baseColor),k=t.toRef(()=>e.color),x=t.toRef(()=>e.selectable||e.activatable),N=Zt(e,"navigationIndex",-1,e=>e??-1),C=t.useId()
...
return Object.assign(n.value,{"--v-overlay-anchor-origin":`${y.anchor.side} ${y.anchor.align}`,transformOrigin:`${y.origin.side} ${y.origin.align}`,top:f(Ur(w)),left:e.isRtl.value?void 0:f(Ur(V)),right:e.isRtl.value?f(Ur(-V)):void 0,minWidth:f("y"===N?Math.min(i.value,h.width):i.value),maxWidth:f(Gr(A(S.x,i.value===1/0?0:i.value,u.value))),maxHeight:f(Gr(A(S.y,s.value===1/0?0:s.value,c.value)))}),{available:S,contentBox:t,flipped:k}}return t.watch(e.target,(e,t)=>{t&&!Array.isArray(t)&&g.unobserve(t),Array.isArray(e)?ht(e,t)||y():e&&g.observe(e)},{immediate:!0}),t.watch(e.contentEl,(e,t)=>{t&&g.unobserve(t),e&&g.observe(e)},{immediate:!0}),t.onScopeDispose(()=>{g.disconnect()}),t.watch(()=>[o.value,r.value,a.offset,a.minWidth,a.minHeight,a.maxWidth,a.maxHeight],()=>y()),t.nextTick(()=>{const e=y()
if(!e)return
const{available:t,contentBox:a}=e
a.height>t.y&&requestAnimationFrame(()=>{y(),requestAnimationFrame(()=>{y()})})}),{updateLocation:y}}},Yr=rt({locationStrategy:{type:[String,Function],default:"static",validator:e=>"function"==typeof e||e in Wr},location:{type:String,default:"bottom"},origin:{type:String,default:"auto"},offset:[Number,String,Array],stickToTarget:Boolean,viewportMargin:{type:[Number,String],default:12}},"VOverlay-location-strategies")
function Ur(e){return Math.round(e*devicePixelRatio)/devicePixelRatio}function Gr(e){return Math.ceil(e*devicePixelRatio)/devicePixelRatio}let Kr=!0
const qr=[]
let Xr=-1
...
o&&(t.watch(()=>e.retainFocus,e=>{e?ui.set(i,{isActive:a,contentEl:r}):ui.delete(i)},{immediate:!0}),t.watch(p,e=>{e?(document.addEventListener("pointerdown",c),document.addEventListener("focusin",d,{once:!0}),document.addEventListener("keydown",v)):(document.removeEventListener("pointerdown",c),document.removeEventListener("focusin",d),document.removeEventListener("keydown",v))},{immediate:!0}),ci++<1&&document.addEventListener("keydown",di)),t.onScopeDispose(()=>{ui.delete(i),clearTimeout(u),document.removeEventListener("pointerdown",c),document.removeEventListener("focusin",d),document.removeEventListener("keydown",v),--ci<1&&document.removeEventListener("keydown",di)})}function pi(){if(!o)return t.shallowRef(!1)
const{ssr:e}=Ro()
...
return a instanceof ShadowRoot&&a}),{dimensionStyles:R}=tl(e),A=pi(),{scopeId:D}=gi()
...
e&&e!==document.scrollingElement&&(O.value=e.scrollTop)}}),It(()=>t.createElementVNode(t.Fragment,null,[a.activator?.({isActive:d.value,targetRef:C,props:t.mergeProps({ref:k},E.value,e.activatorProps)}),A.value&&g.value&&t.createVNode(t.Teleport,{disabled:!P.value,to:P.value},{default:()=>[t.createElementVNode("div",t.mergeProps({class:["v-overlay",{"v-overlay--absolute":e.absolute||e.contained,"v-overlay--active":d.value,"v-overlay--contained":e.contained},v.value,p.value,e.class],style:[w.value,{"--v-overlay-opacity":e.opacity,top:f(O.value)},e.style],ref:i,onKeydown:z},D,l),[t.createVNode(xi,t.mergeProps({color:y,modelValue:d.value&&!!e.scrim,ref:s},_.value),null),t.createVNode(dl,{appear:!0,persisted:!0,transition:e.transition,target:x.value,onAfterEnter:H,onAfterLeave:W},{default:()=>[t.withDirectives(t.createElementVNode("div",t.mergeProps({ref:u,class:["v-overlay__content",e.contentClass],style:[R.value,T.value]},I.value,e.contentProps),[a.default?.({isActive:d})]),[[t.vShow,d.value],[ki,{handler:F,closeConditional:$,include:()=>[S.value]}]])]})])]})])),{activatorEl:S,scrimEl:s,target:x,animateClick:j,contentEl:u,rootEl:i,globalTop:b,localTop:V,updateLocation:B}}}),Ei=rt({id:String,submenu:Boolean,...x(Ni({captureFocus:!0,closeDelay:250,closeOnContentClick:!0,locationStrategy:"connected",location:void 0,openDelay:300,scrim:!1,scrollStrategy:"reposition",transition:{component:Da}}),["absolute"])},"VMenu"),Ii=ft()({name:"VMenu",props:Ei(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=Zt(e,"modelValue"),{scopeId:n}=gi(),{isRtl:o}=ca(),r=t.useId(),i=t.toRef(()=>e.id||`v-menu-${r}`),s=t.ref(),u=t.inject(ai,null),c=t.shallowRef(new Set)
...
n.value=l?Math.min(n.value,t):t,a===t&&l===n.value||(y[e]=t,k())}}}const Ki=rt({items:{type:Array,default:()=>[]},renderless:Boolean,...Ui(),...it(),...el()},"VVirtualScroll"),qi=ft()({name:"VVirtualScroll",props:Ki(),setup(e,{slots:a}){const l=st("VVirtualScroll"),{dimensionStyles:n}=tl(e),{calculateVisibleItems:o,containerRef:r,markerRef:i,handleScroll:s,handleScrollend:u,handleItemResize:c,scrollToIndex:d,paddingTop:v,paddingBottom:p,computedItems:m}=Gi(e,t.toRef(()=>e.items))
return Xt(()=>e.renderless,()=>{function e(e=!1){const t=e?"addEventListener":"removeEventListener"
r.value===document.documentElement?(document[t]("scroll",s,{passive:!0}),document[t]("scrollend",u)):(r.value?.[t]("scroll",s,{passive:!0}),r.value?.[t]("scrollend",u))}t.onMounted(()=>{r.value=xt(l.vnode.el,!0),e(!0)}),t.onScopeDispose(e)}),It(()=>{const l=m.value.map(l=>t.createVNode(Yi,{key:l.key,renderless:e.renderless,"onUpdate:height":e=>c(l.index,e)},{default:e=>a.default?.({item:l.raw,index:l.index,...e})}))
...
return e.hideSelected?t.filter(t=>!g.value.some(a=>(e.valueComparator||ht)(a,t))):t}),I=t.computed(()=>e.hideNoData&&!E.value.length||y.isReadonly.value||y.isDisabled.value),_=Zt(e,"menu"),R=t.computed({get:()=>_.value,set:e=>{_.value&&!e&&r.value?.ΨopenChildren.size||e&&I.value||(_.value=e)}}),{menuId:A,ariaExpanded:D,ariaControls:T}=ns(0,R),B=t.computed(()=>({...e.menuProps,activatorProps:{...e.menuProps?.activatorProps||{},"aria-haspopup":"listbox"}})),F=t.ref(),$=Xi(F,n),{onTabKeydown:M}=Zi({groups:[{type:"element",contentRef:i},{type:"list",contentRef:F,displayItemsCount:()=>E.value.length},{type:"element",contentRef:s}],onLeave:()=>{R.value=!1,n.value?.focus()}})
...
F.value.focus(t>=0?t:"first")}}function U(){p.value="",w.value&&n.value?.focus()}function G(e){w.value=!0}function K(e){n.value?.$el.contains(e.relatedTarget)||(w.value=!1)}function q(e){if(null==e)g.value=[]
...
return e.multiple?a:a[0]??null}),w=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:V.value.length),S=vo(e),{filteredItems:k,getMatches:x}=ts(e,p,()=>v.value??(i.value?"":b.value)),N=t.computed(()=>e.hideSelected&&null===v.value?k.value.filter(e=>!V.value.some(t=>t.value===e.value)):k.value),C=t.toRef(()=>e.closableChips&&!S.isReadonly.value&&!S.isDisabled.value),E=t.computed(()=>!(!e.chips&&!a.chip)),I=t.computed(()=>E.value||!!a.selection),_=t.computed(()=>V.value.map(e=>e.props.value)),R=t.computed(()=>N.value.find(e=>"item"===e.type&&!e.props.disabled)),A=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&b.value===R.value?.title)&&N.value.length>0&&!i.value&&!s.value),D=t.computed(()=>e.hideNoData&&!N.value.length||S.isReadonly.value||S.isDisabled.value),T=Zt(e,"menu"),B=t.computed({get:()=>T.value,set:e=>{T.value&&!e&&u.value?.ΨopenChildren.size||e&&D.value||(T.value=e)}}),{menuId:F,ariaExpanded:$,ariaControls:M}=ns(0,B),z=t.ref(),L=t.ref(),O=t.ref(),j=Xi(z,n),{onTabKeydown:H}=Zi({groups:[{type:"element",contentRef:L},{type:"list",contentRef:z,displayItemsCount:()=>N.value.length},{type:"element",contentRef:O}],onLeave:()=>{B.value=!1,n.value?.focus()}})
...
function Ds(e){const t=Xs(e)
return t.day=1,Gs(t),Ks(t),t}function Ts(e){const t=Xs(e)
...
return e.hasTime&&a&&o&&(l=Os(t),n=Os(e),o=l===n),e.past=n<l,e.present=o,e.future=n>l,e}function Ws(e){return e instanceof Date||"number"==typeof e&&isFinite(e)}function Ys(e,t,a){return e.hasTime!==t&&(e.hasTime=t,t||(e.hour=23,e.minute=59,e.time=Qs(e))),e}function Us(e,t,a){return e.hasTime=!0,e.hour=0,e.minute=0,Js(e,t),Ks(e),a&&Hs(e,a,!0),e}function Gs(e){return e.weekday=function(e){if(e.hasDay){const t=Math.floor,a=e.day,l=(e.month+9)%12+1,n=t(e.year/100),o=e.year%100-(e.month<=2?1:0)
...
r(e,a.now),i(e,a.now),r(e,a.today)}return t.watch(l,s),s(),n(),{times:a,parsedNow:l,updateTimes:s,setPresent:n,getNow:o,updateDay:r,updateTime:i}}({now:e.now}),n=ua(e),o=Eu(),r=t.computed(()=>"month"===e.type?Ds(Ms(e.start,!0)):Ms(e.start,!0)),i=t.computed(()=>{const t=r.value,a=e.end&&Ms(e.end)||t,l=js(a)<js(t)?t:a
return"month"===e.type?Ts(l):l}),s=t.computed(()=>$s(e.modelValue)?Ms(e.modelValue,!0):r.value||a.today),u=t.computed(()=>{const t=Array.isArray(e.weekdays)?e.weekdays:(e.weekdays||"").split(",").map(e=>parseInt(e,10)),a=o.toJsDate(o.startOfWeek(o.date(),e.firstDayOfWeek)).getDay()
...
o.push(Us(i,l,n))}return o}(e,t,l,n,i))}),p=t.computed(()=>e.intervalFormat?e.intervalFormat:ru(a.locale.current.value,(e,t)=>t?0===e.minute?{timeZone:"UTC",hour:"numeric"}:{timeZone:"UTC",hour:"numeric",minute:"2-digit"}:{timeZone:"UTC",hour:"2-digit",minute:"2-digit"}))
...
return!(t.hour===e.hour&&t.minute===e.minute)},intervalStyleDefault:function(e){},getTimestampAtEvent:function(e,t){const l=Xs(t),n=e.currentTarget.getBoundingClientRect(),r=u.value,s=e,c=e,d=s.changedTouches||s.touches,v=((d&&d[0]?d[0].clientY:c.clientY)-n.top)/i.value
return Us(l,r+Math.floor(v*o.value),a.times.now)},getSlotScope:function(e){const t=Xs(e)
...
window.removeEventListener("resize",a,l),delete e._onResize[t.instance.$.uid]}},Du=mt({name:"VCalendarDaily",directives:{vResize:Au},props:{color:String,shortWeekdays:{type:Boolean,default:!0},shortIntervals:{type:Boolean,default:!0},hideHeader:Boolean,...Iu(),...Pu()},setup(e,{slots:a,attrs:l}){const n=t.ref(0),o=t.ref(),r=Ru(e)
...
function Tu(e,t){return"string"==typeof e?e.split(/\s*,\s/):Array.isArray(e)?e.map(e=>{if("string"==typeof e)return e
...
return{...e,categoryName:a}}):[]}const Bu=mt({name:"VCalendarCategory",props:{categories:{type:[Array,String],default:""},categoryText:[String,Function],categoryForInvalid:{type:String,default:""},...Iu(),...Pu()},setup(e,{slots:a,attrs:l}){const n=Ru(e),o=t.computed(()=>Tu(e.categories,e.categoryText))
...
function $u(e){const t=e.toLowerCase()
return Fu[t]||t}function Mu(e,t=!1){const l={keys:[],separators:[]}
...
const n=[],o=[]
let r=""
const i=e=>{r&&(e&&o.push(e),n.push($u(r)),r="")}
for(let t=0;t<e.length;t++){const a=e[t],l=e[t+1];["+","/","_","-"].includes(a)?a===l?(i(a),n.push(a),t++):["+","/","_"].includes(a)?i(a):r+=a:r+=a}i()
return n.some(e=>e.length>1&&e.includes("-")&&"--"!==e)?(t||a(`Invalid hotkey combination: "${e}" has invalid structure`),l):0===n.length&&e?{keys:[$u(e)],separators:o}:{keys:n,separators:o}}function zu(e){if(!e)return a("Invalid hotkey sequence: empty string provided"),[]
...
return i.every(e=>Mu(e,!0).keys.length>0)?i:(a(`Invalid hotkey sequence: "${e}" contains invalid combinations`),[])}const Lu={"credit-card":"#### - #### - #### - ####",date:"##/##/####","date-time":"##/##/#### ##:##","iso-date":"####-##-##","iso-date-time":"####-##-## ##:##",phone:"(###) ### - ####",social:"###-##-####",time:"##:##","time-with-seconds":"##:##:##"},Ou={"#":{pattern:/[0-9]/},A:{pattern:/[A-Z]/i,convert:e=>e.toUpperCase()},a:{pattern:/[a-z]/i,convert:e=>e.toLowerCase()},N:{pattern:/[0-9A-Z]/i,convert:e=>e.toUpperCase()},n:{pattern:/[0-9a-z]/i,convert:e=>e.toLowerCase()},X:{pattern:/[-!$%^&*()_+|~=`{}[\]:";'<>?,./\\ ]/}}
const ju=mt({name:"VCalendarWeekly",props:{minWeeks:{validate:Bs,default:1},monthFormat:Function,showWeek:Boolean,color:String,shortWeekdays:{type:Boolean,default:!0},showMonthOnFirst:{type:Boolean,default:!0},shortMonths:{type:Boolean,default:!0},hideHeader:Boolean,...Iu()},setup(e,{slots:a,attrs:l}){const n=_u(e),o=wa(),r=t.computed(()=>parseInt(String(e.minWeeks))),i=t.computed(()=>{const e=r.value*n.parsedWeekdays.value.length
...
function Hu(e,t=0){const a=e.map(e=>({event:e,columnCount:0,column:0,left:0,width:100}))
return a.sort((e,a)=>Math.max(t,e.event.startTimestampIdentifier)-Math.max(t,a.event.startTimestampIdentifier)||a.event.endTimestampIdentifier-e.event.endTimestampIdentifier),a}function Wu(e,t,a,l,n=!0){return n?!(e>=l||t<=a):!(e>l||t<a)}function Yu(e){e.forEach(t=>{t.visuals.forEach(t=>{t.columnCount=e.length})})}function Uu(e){return[e.startTimestampIdentifier,e.endTimestampIdentifier]}function Gu(e){return[e.startIdentifier,e.endIdentifier]}function Ku(e,t){return[Math.max(t,e.startTimestampIdentifier),Math.min(t+864e5,e.endTimestampIdentifier)]}function qu(e){const t={groups:[],min:-1,max:-1,reset:()=>{t.groups=[],t.min=t.max=-1},getVisuals:(a,l,n,o=!1)=>{(a.weekday===e||o)&&t.reset()
const r=Hu(l,js(a))
return r.forEach(e=>{const[a,l]=n?Uu(e.event):Gu(e.event)
t.groups.length>0&&!Wu(a,l,t.min,t.max,n)&&(Yu(t.groups),t.reset())
let o=function(e,t,a,l){for(let n=0;n<e.length;n++){const o=e[n]
let r=!1
if(Wu(t,a,o.start,o.end,l))for(let e=0;e<o.visuals.length;e++){const n=o.visuals[e],[i,s]=l?Uu(n.event):Gu(n.event)
if(Wu(t,a,i,s,l)){r=!0
break}}if(!r)return n}return-1}(t.groups,a,l,n);-1===o&&(o=t.groups.length,t.groups.push({start:a,end:l,visuals:[]}))
const r=t.groups[o]
r.visuals.push(e),r.start=Math.min(r.start,a),r.end=Math.max(r.end,l),e.column=o,-1===t.min?(t.min=a,t.max=l):(t.min=Math.min(t.min,a),t.max=Math.max(t.max,l))}),Yu(t.groups),n&&t.reset(),r}}
return t}const Xu=100
function Zu(e,t){for(const a of e){const{visual:l,parent:n}=a,o=nc(a)+1,r=n?n.visual.left:0,i=Xu-r,s=Math.min(5,Xu/o),u=Qu(a,e),c=i/(o-a.index+1),d=i/(o-a.index+(a.sibling?1:0))*u
n&&(l.left=a.sibling?r+c:r+s),l.width=ac(a,e,t)?Xu-l.left:Math.min(Xu-l.left,1.7*d)}}function Qu(e,t){if(!e.children.length)return 1
const a=e.index+t.length
return e.children.reduce((e,t)=>Math.min(e,t.index),a)-e.index}function Ju(e,t){const a=function(e,t){const a=[]
for(const l of t)Wu(e.start,e.end,l.start,l.end)&&a.push(l.index)
return a}(e,t)
a.sort()
for(let e=0;e<a.length;e++)if(e<a[e])return e
return!1}function ec(e,t,a,l,n=!1){const o=[]
for(const n of t)n.index>=a&&n.index<=l&&Wu(e.start,e.end,n.start,n.end)&&o.push(n)
if(n&&o.length>0){const e=o.reduce((e,t)=>Math.min(e,t.index),o[0].index)
return o.filter(t=>t.index===e)}return o}function tc(e,t){let a=null
for(const l of t)Wu(e.start,e.end,l.start,l.end)&&(null===a||l.index>a.index)&&(a=l)
return a}function ac(e,t,a){for(const l of t)if(l!==e&&l.index>e.index&&Wu(e.start,oc(e.start,a),l.start,l.end))return!1
return!0}function lc(e,t){const[a,l]=Ku(e.event,t)
return{parent:null,sibling:!0,index:0,visual:e,start:a,end:l,children:[]}}function nc(e){let t=e.index
for(const a of e.children){const e=nc(a)
e>t&&(t=e)}return t}function oc(e,t){const a=e%100,l=a+t
return e-a+100*Math.floor(l/60)+l%60}const rc={stack:(e,t,a)=>{const l=qu(t)
return(e,t,n,o)=>{if(!n)return l.getVisuals(e,t,n,o)
const r=js(e),i=Hu(t,r),s=function(e,t){const a=[]
for(const l of e){const[e,n]=Ku(l.event,t)
let o=!1
for(const t of a)if(Wu(e,n,t.start,t.end)){t.visuals.push(l),t.end=Math.max(t.end,n),o=!0
break}o||a.push({start:e,end:n,visuals:[l]})}return a}(i,r)
for(const e of s){const t=[]
for(const l of e.visuals){const e=lc(l,r),n=Ju(e,t)
if(!1===n){const l=tc(e,t)
l&&(e.parent=l,e.sibling=Wu(e.start,e.end,l.start,oc(l.start,a)),e.index=l.index+1,l.children.push(e))}else{const[l]=ec(e,t,n-1,n-1),o=ec(e,t,n+1,n+t.length,!0)
e.children=o,e.index=n,l&&(e.parent=l,e.sibling=Wu(e.start,e.end,l.start,oc(l.start,a)),l.children.push(e))
for(const t of o){t.parent===l&&(t.parent=e)
t.index-e.index<=1&&e.sibling&&Wu(e.start,oc(e.start,a),t.start,t.end)&&(t.sibling=!0)}}t.push(e)}Zu(t,a)}return i.sort((e,t)=>e.left-t.left||e.event.startTimestampIdentifier-t.event.startTimestampIdentifier),i}},column:(e,t,a)=>{const l=qu(t)
...
function ic(e,t){return t>=e.startIdentifier&&t<=e.endIdentifier}function sc(e,t,a,l){return a===e.startIdentifier||l===t.weekday&&ic(e,a)}const uc=rt({events:{type:Array,default:()=>[]},eventStart:{type:String,default:"start"},eventEnd:{type:String,default:"end"},eventTimed:{type:[String,Function],default:"timed"},eventCategory:{type:[String,Function],default:"category"},eventHeight:{type:Number,default:20},eventColor:{type:[String,Function],default:"primary"},eventTextColor:{type:[String,Function]},eventName:{type:[String,Function],default:"name"},eventOverlapThreshold:{type:[String,Number],default:60},eventOverlapMode:{type:[String,Function],default:"stack",validate:e=>e in rc||"function"==typeof e},eventMore:{type:Boolean,default:!0},eventMoreText:{type:String,default:"$vuetify.calendar.moreEvents"},eventRipple:{type:[Boolean,Object],default:null},eventMarginBottom:{type:Number,default:1}},"VCalendar-events")
function cc(e,a,l){const n=_u(e),o=t.computed(()=>!Array.isArray(e.events)||0===e.events.length),r=t.computed(()=>"category"===e.type),i=t.computed(()=>"function"==typeof e.eventTimed?e.eventTimed:t=>!!t[e.eventTimed]),s=t.computed(()=>"function"==typeof e.eventCategory?e.eventCategory:t=>t[e.eventCategory]),u=t.computed(()=>e.events?e.events.map((t,a)=>function(e,t,a,l,n=!1,o=!1){const r=e[a],i=e[l],s=Ms(r,!0),u=i?Ms(i,!0):s,c=Ws(r)?Ys(s,n):s,d=Ws(i)?Ys(u,n):u,v=Ls(c),p=js(c),m=Ls(d),f=c.hasTime?0:2359
...
return u.value.filter(l=>sc(l,e,t,a))}function C(e){const t=Ls(e),a=m.value[0]
return u.value.filter(l=>l.allDay&&(r.value?ic(l,t):sc(l,e,t,a))&&x(l,e.category))}function E(e){return u.value.filter(t=>!t.allDay&&function(e,t,a){if(a){const l=Js(Xs(t),a[0]),n=Js(Xs(t),a[1]),o=e.startTimestampIdentifier<js(n),r=e.endTimestampIdentifier>js(l)
return o&&r}return ic(e,Ls(t))}(t,e,e.intervalRange)&&x(t,e.category))}return{...n,noEvents:o,parsedEvents:u,parsedEventOverlapThreshold:c,eventTimedFunction:i,eventCategoryFunction:s,eventTextColorFunction:d,eventNameFunction:v,eventModeFunction:p,eventWeekdays:m,categoryMode:r,eventColorFunction:f,eventsRef:g,updateEventVisibility:function(){if(o.value||!e.eventMore)return
...
t&&(n=n.concat(t))}return n}}}}}const dc=ft()({name:"VCalendar",directives:{vResize:Au},props:{modelValue:{type:[String,Number,Date],validate:$s},categoryDays:{type:[Number,String],default:1,validate:e=>isFinite(parseInt(e))&&parseInt(e)>0},categories:{type:[Array,String],default:""},categoryText:{type:[String,Function]},maxDays:{type:Number,default:7},categoryHideDynamic:{type:Boolean},categoryShowAll:{type:Boolean},categoryForInvalid:{type:String,default:""},...Iu(),...uc()},setup(e,{slots:a,attrs:l,emit:n}){const o=t.ref(),r=cc(e,a,l),i=t.ref(null),s=t.ref(null),u=t.computed(()=>parseInt(String(e.categoryDays))||1),c=t.computed(()=>Tu(e.categories,e.categoryText)),d=t.computed(()=>{const t=r.parsedValue.value
let a=null,l=e.maxDays,n=c.value,o=t,i=t
switch(e.type){case"month":a=ju,o=Ds(t),i=Ts(t)
break
case"week":a=Du,o=r.getStartOfWeek(t),i=r.getEndOfWeek(t),l=7
break
case"day":a=Du,l=1
break
case"4day":a=Du,i=au(Xs(i),eu,3),Ks(i),l=4
break
case"custom-weekly":a=ju,o=r.parsedStart.value||t,i=r.parsedEnd.value
break
...
return t.withDirectives(t.createVNode(u,t.mergeProps({ref:o,class:["v-calendar",{"v-calendar-events":!r.noEvents.value}],role:"grid"},u.filterProps(e),{start:a.date,end:i.date,maxDays:s,weekdays:r.effectiveWeekdays.value,categories:c,"onClick:date":(e,t)=>{l["onUpdate:modelValue"]&&n("update:modelValue",t.date)}}),r.getScopedSlots()),[[Au,r.updateEventVisibility,void 0,{quiet:!0}]])}),Vo({...r,lastStart:i,lastEnd:s,parsedCategoryDays:u,renderProps:d,eventWeekdays:v,categoryMode:p,title:g,monthLongFormatter:m,monthShortFormatter:f,parsedCategories:c,checkChange:h,move:y,next:function(e=1){y(e)},prev:function(e=1){y(-e)},getCategoryList:b},o)}}),vc=rt({...it(),...xa()},"VCardActions"),pc=ft()({name:"VCardActions",props:vc(),setup:(e,{slots:a})=>(vt({VBtn:{slim:!0,variant:"text"}}),It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-actions",e.class]),style:t.normalizeStyle(e.style)},a)),{})}),mc=rt({opacity:[Number,String],...it(),...xa()},"VCardSubtitle"),fc=ft()({name:"VCardSubtitle",props:mc(),setup:(e,{slots:a})=>(It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-subtitle",e.class]),style:t.normalizeStyle([{"--v-card-subtitle-opacity":e.opacity},e.style])},a)),{})}),gc=gt("v-card-title"),hc=rt({appendAvatar:String,appendIcon:_t,prependAvatar:String,prependIcon:_t,subtitle:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...it(),...Al(),...xa()},"VCardItem"),yc=ft()({name:"VCardItem",props:hc(),setup:(e,{slots:a})=>(It(()=>{const l=!(!e.prependAvatar&&!e.prependIcon),n=!(!l&&!a.prepend),o=!(!e.appendAvatar&&!e.appendIcon),r=!(!o&&!a.append),i=!(null==e.title&&!a.title),s=!(null==e.subtitle&&!a.subtitle)
return t.createVNode(e.tag,{class:t.normalizeClass(["v-card-item",e.class]),style:t.normalizeStyle(e.style)},{default:()=>[n&&t.createElementVNode("div",{key:"prepend",class:"v-card-item__prepend"},[a.prepend?t.createVNode(Ja,{key:"prepend-defaults",disabled:!l,defaults:{VAvatar:{density:e.density,image:e.prependAvatar},VIcon:{density:e.density,icon:e.prependIcon}}},a.prepend):t.createElementVNode(t.Fragment,null,[e.prependAvatar&&t.createVNode(Gn,{key:"prepend-avatar",density:e.density,image:e.prependAvatar},null),e.prependIcon&&t.createVNode(Ql,{key:"prepend-icon",density:e.density,icon:e.prependIcon},null)])]),t.createElementVNode("div",{class:"v-card-item__content"},[i&&t.createVNode(gc,{key:"title"},{default:()=>[a.title?.()??t.toDisplayString(e.title)]}),s&&t.createVNode(fc,{key:"subtitle"},{default:()=>[a.subtitle?.()??t.toDisplayString(e.subtitle)]}),a.default?.()]),r&&t.createElementVNode("div",{key:"append",class:"v-card-item__append"},[a.append?t.createVNode(Ja,{key:"append-defaults",disabled:!o,defaults:{VAvatar:{density:e.density,image:e.appendAvatar},VIcon:{density:e.density,icon:e.appendIcon}}},a.append):t.createElementVNode(t.Fragment,null,[e.appendIcon&&t.createVNode(Ql,{key:"append-icon",density:e.density,icon:e.appendIcon},null),e.appendAvatar&&t.createVNode(Gn,{key:"append-avatar",density:e.density,image:e.appendAvatar},null)])])]})}),{})}),bc=rt({opacity:[Number,String],...it(),...xa()},"VCardText"),Vc=ft()({name:"VCardText",props:bc(),setup:(e,{slots:a})=>(It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-card-text",e.class]),style:t.normalizeStyle([{"--v-card-text-opacity":e.opacity},e.style])},a)),{})}),wc=rt({appendAvatar:String,appendIcon:_t,disabled:Boolean,flat:Boolean,hover:Boolean,image:String,link:{type:Boolean,default:void 0},prependAvatar:String,prependIcon:_t,ripple:{type:[Boolean,Object],default:!0},subtitle:{type:[String,Number,Boolean],default:void 0},text:{type:[String,Number,Boolean],default:void 0},title:{type:[String,Number,Boolean],default:void 0},...hl(),...it(),...Al(),...el(),...bl(),...rn(),...Sl(),...dn(),...sl(),...fn(),...xa(),...va(),...Fl({variant:"elevated"})},"VCard"),Sc=ft()({name:"VCard",directives:{vRipple:An},props:wc(),setup(e,{attrs:a,slots:l}){const{themeClasses:n}=Va(e),{borderClasses:o}=yl(e),{colorClasses:r,colorStyles:i,variantClasses:s}=$l(e),{densityClasses:u}=Dl(e),{dimensionStyles:c}=tl(e),{elevationClasses:d}=Vl(e),{loaderClasses:v}=sn(e),{locationStyles:p}=kl(e),{positionClasses:m}=vn(e),{roundedClasses:g}=ul(e),h=mn(e,a),y=t.shallowRef(void 0)
...
return t.withDirectives(t.createVNode(V,t.mergeProps(h.linkProps,{class:["v-card",{"v-card--disabled":e.disabled,"v-card--flat":e.flat,"v-card--hover":e.hover&&!(e.disabled||e.flat),"v-card--link":b},n.value,o.value,r.value,u.value,d.value,v.value,m.value,g.value,s.value,e.class],style:[i.value,c.value,p.value,{"--v-card-height":f(e.height)},e.style],onClick:b&&h.navigate.value,tabindex:e.disabled?-1:void 0}),{default:()=>[C&&t.createElementVNode("div",{key:"image",class:"v-card__image"},[l.image?t.createVNode(Ja,{key:"image-defaults",disabled:!e.image,defaults:{VImg:{cover:!0,src:e.image}}},l.image):t.createVNode(gl,{key:"image-img",cover:!0,src:e.image},null)]),t.createVNode(un,{name:"v-card",active:!!e.loading,color:y.value},{default:l.loader}),E&&t.createVNode(yc,{key:"item",prependAvatar:e.prependAvatar,prependIcon:e.prependIcon,title:e.title,subtitle:e.subtitle,appendAvatar:e.appendAvatar,appendIcon:e.appendIcon},{default:l.item,prepend:l.prepend,title:l.title,subtitle:l.subtitle,append:l.append}),I&&t.createVNode(Vc,{key:"text"},{default:()=>[l.text?.()??e.text]}),l.default?.(),l.actions&&t.createVNode(pc,null,{default:l.actions}),Bl(b,"v-card")]}),[[An,b&&e.ripple]])}),{}}})
function kc(e,t){const a=e.changedTouches[0]
...
t.touchstartX=a.clientX,t.touchstartY=a.clientY,t.start?.({originalEvent:e,...t})}(e,t),touchend:e=>kc(e,t),touchmove:e=>function(e,t){const a=e.changedTouches[0]
...
V(n).forEach(e=>{a.removeEventListener(e,n[e])}),delete a._touchHandlers[l]}},Nc=Symbol.for("vuetify:v-window"),Cc=Symbol.for("vuetify:v-window-group"),Ec=rt({continuous:Boolean,nextIcon:{type:[Boolean,String,Function,Object],default:"$next"},prevIcon:{type:[Boolean,String,Function,Object],default:"$prev"},reverse:Boolean,showArrows:{type:[Boolean,String],validator:e=>"boolean"==typeof e||"hover"===e},verticalArrows:[Boolean,String],touch:{type:[Object,Boolean],default:void 0},direction:{type:String,default:"horizontal"},modelValue:null,disabled:Boolean,selectedClass:{type:String,default:"v-window-item--active"},mandatory:{type:[Boolean,String],default:"force"},crossfade:Boolean,transitionDuration:Number,...it(),...xa(),...va()},"VWindow"),Ic=ft()({name:"VWindow",directives:{vTouch:xc},props:Ec(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{themeClasses:l}=Va(e),{isRtl:n}=ca(),{t:r}=sa(),i=Hl(e,Cc),s=t.ref(),u=t.computed(()=>n.value?!e.reverse:e.reverse),d=t.shallowRef(!1),v=t.computed(()=>{if(e.crossfade)return"v-window-crossfade-transition"
...
l.scrollTop!==n.top&&l.scrollTo({...n,behavior:"instant"})})})},{flush:"sync"}),t.provide(Nc,{transition:v,isReversed:d,transitionCount:p,transitionHeight:m,rootRef:s})
...
const $c={h:0,s:0,v:0,a:1},Mc={inputProps:{type:"number",min:0},inputs:[{label:"R",max:255,step:1,getValue:e=>Math.round(e.r),getColor:(e,t)=>({...e,r:Number(t)}),localeKey:"redInput"},{label:"G",max:255,step:1,getValue:e=>Math.round(e.g),getColor:(e,t)=>({...e,g:Number(t)}),localeKey:"greenInput"},{label:"B",max:255,step:1,getValue:e=>Math.round(e.b),getColor:(e,t)=>({...e,b:Number(t)}),localeKey:"blueInput"},{label:"A",max:1,step:.01,getValue:({a:e})=>null!=e?Math.round(100*e)/100:1,getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:We,from:Ue},zc={inputProps:{type:"number",min:0},inputs:[{label:"H",max:360,step:1,getValue:e=>Math.round(e.h),getColor:(e,t)=>({...e,h:Number(t)}),localeKey:"hueInput"},{label:"S",max:1,step:.01,getValue:e=>Math.round(100*e.s)/100,getColor:(e,t)=>({...e,s:Number(t)}),localeKey:"saturationInput"},{label:"L",max:1,step:.01,getValue:e=>Math.round(100*e.l)/100,getColor:(e,t)=>({...e,l:Number(t)}),localeKey:"lightnessInput"},{label:"A",max:1,step:.01,getValue:({a:e})=>null!=e?Math.round(100*e)/100:1,getColor:(e,t)=>({...e,a:Number(t)}),localeKey:"alphaInput"}],to:Ge,from:Ke},Lc={inputProps:{type:"text"},inputs:[{label:"HEXA",getValue:e=>e,getColor:(e,t)=>t,localeKey:"hexaInput"}],to:et,from:function(e){return Ue(Je(e))}},Oc={rgb:{...Mc,inputs:Mc.inputs?.slice(0,3)},rgba:Mc,hsl:{...zc,inputs:zc.inputs.slice(0,3)},hsla:zc,hex:{...Lc,inputs:[{label:"HEX",getValue:e=>e.slice(0,7),getColor:(e,t)=>t,localeKey:"hexInput"}]},hexa:Lc},jc=({label:e,...a})=>t.createElementVNode("div",{class:"v-color-picker-edit__input"},[t.createElementVNode("input",t.normalizeProps(t.guardReactiveProps(a)),null),t.createElementVNode("span",null,[e])]),Hc=mt({name:"VColorPickerEdit",props:rt({color:Object,disabled:Boolean,readonly:Boolean,mode:{type:String,default:"rgba",validator:e=>Object.keys(Oc).includes(e)},modes:{type:Array,default:()=>Object.keys(Oc),validator:e=>Array.isArray(e)&&e.every(e=>Object.keys(Oc).includes(e))},...it()},"VColorPickerEdit")(),emits:{"update:color":e=>!0,"update:mode":e=>!0},setup(e,{emit:a}){const{t:l}=sa(),n=t.computed(()=>e.modes.map(e=>({...Oc[e],name:e}))),o=t.computed(()=>{const t=n.value.find(t=>t.name===e.mode)
if(!t)return[]
...
l&&a("update:color",t.from(r(o??t.to($c),l.value)))}}))})
return It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-edit",e.class]),style:t.normalizeStyle(e.style)},[o.value?.map(e=>t.createVNode(jc,e,null)),n.value.length>1&&t.createVNode(Tn,{icon:"$unfold",size:"x-small",variant:"plain","aria-label":l("$vuetify.colorPicker.ariaLabel.changeFormat"),onClick:()=>{const t=n.value.findIndex(t=>t.name===e.mode)
a("update:mode",n.value[(t+1)%n.value.length].name)}},null)])),{}}}),Wc=Symbol.for("vuetify:v-slider")
function Yc(e,t,a){const l="vertical"===a,n=t.getBoundingClientRect(),o="touches"in e?e.touches[0]:e
return l?o.clientY-(n.top+n.height/2):o.clientX-(n.left+n.width/2)}const Uc=rt({disabled:{type:Boolean,default:null},error:Boolean,readonly:{type:Boolean,default:null},max:{type:[Number,String],default:100},min:{type:[Number,String],default:0},step:{type:[Number,String],default:0},thumbColor:String,thumbLabel:{type:[Boolean,String],default:void 0,validator:e=>"boolean"==typeof e||"always"===e||"hover"===e},thumbSize:{type:[Number,String],default:20},showTicks:{type:[Boolean,String],default:!1,validator:e=>"boolean"==typeof e||"always"===e},ticks:{type:[Array,Object]},tickSize:{type:[Number,String],default:2},color:String,trackColor:String,trackFillColor:String,trackSize:{type:[Number,String],default:4},direction:{type:String,default:"horizontal",validator:e=>["vertical","horizontal"].includes(e)},reverse:Boolean,noKeyboard:Boolean,...sl(),...bl({elevation:1}),ripple:{type:Boolean,default:!0}},"Slider"),Gc=e=>{const a=t.computed(()=>parseFloat(e.min)),l=t.computed(()=>parseFloat(e.max)),n=t.computed(()=>Number(e.step)>0?parseFloat(e.step):0),o=t.computed(()=>Math.max(D(n.value),D(a.value)))
...
_.value=r(a),_.value&&(C.value=!0,_.value.contains(a.target)?E.value=Yc(a,_.value,e.direction):(E.value=0,null!=o&&n({value:o})),null!=o&&l({value:o}),t.nextTick(()=>_.value?.focus()))},T={passive:!0,capture:!0}
...
return t.provide(Wc,j),j},qc=rt({focused:Boolean,max:{type:Number,required:!0},min:{type:Number,required:!0},modelValue:{type:Number,required:!0},position:{type:Number,required:!0},ripple:{type:[Boolean,Object],default:!0},name:String,noKeyboard:Boolean,...it()},"VSliderThumb"),Xc=ft()({name:"VSliderThumb",directives:{vRipple:An},props:qc(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a,emit:l}){const n=t.inject(Wc),{isRtl:o,rtlClasses:r}=ca()
...
return t.createVNode(ho,t.mergeProps({ref:r,class:["v-slider",{"v-slider--has-labels":!!a["tick-label"]||y.value,"v-slider--focused":S.value,"v-slider--pressed":v.value,"v-slider--disabled":b.value},i.value,e.class],style:e.style},l,s,{focused:S.value}),{...a,prepend:h?l=>t.createElementVNode(t.Fragment,null,[a.label?.(l)??(e.label?t.createVNode(qn,{id:l.id.value,class:"v-slider__label",text:e.label},null):void 0),a.prepend?.(l)]):void 0,default:({id:l,messagesId:n})=>t.createElementVNode("div",{class:"v-slider__container",onMousedown:V.value?void 0:m,onTouchstartPassive:V.value?void 0:f},[t.createElementVNode("input",{id:l.value,name:e.name||l.value,disabled:b.value,readonly:V.value,tabindex:"-1",value:u.value},null),t.createVNode(Qc,{ref:g,start:0,stop:N.value},{"tick-label":a["tick-label"]}),t.createVNode(Xc,t.mergeProps({ref:o,"aria-describedby":n.value,focused:S.value,noKeyboard:w.value,min:c.value,max:d.value,modelValue:u.value,"onUpdate:modelValue":e=>u.value=e,position:N.value,elevation:e.elevation,onFocus:k,onBlur:x,ripple:e.ripple,name:e.name},p),{"thumb-label":a["thumb-label"]})])})}),Vo({focus:()=>o.value?.$el.focus()},r)}}),td=rt({color:{type:Object},disabled:Boolean,readonly:Boolean,hideAlpha:Boolean,hideEyeDropper:Boolean,eyeDropperIcon:{type:_t,default:"$eyeDropper"},...it()},"VColorPickerPreview"),ad=mt({name:"VColorPickerPreview",props:td(),emits:{"update:color":e=>!0},setup(e,{emit:a}){const{t:l}=sa(),n=new AbortController,o=t.toRef(()=>!e.disabled&&!e.readonly)
async function r(){if(!s||!o.value)return
const t=new window.EyeDropper
try{const l=Ue(He((await t.open({signal:n.signal})).sRGBHex))
a("update:color",{...e.color??$c,...l})}catch(e){}}return t.onUnmounted(()=>n.abort()),It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-color-picker-preview",{"v-color-picker-preview--hide-alpha":e.hideAlpha},e.class]),style:t.normalizeStyle(e.style)},[s&&!e.hideEyeDropper&&t.createElementVNode("div",{class:"v-color-picker-preview__eye-dropper",key:"eyeDropper"},[t.createVNode(Tn,{"aria-label":l("$vuetify.colorPicker.ariaLabel.eyedropper"),density:"comfortable",disabled:e.disabled,readonly:e.readonly,icon:e.eyeDropperIcon,variant:"plain",onClick:r},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__dot"},[t.createElementVNode("div",{style:{background:Xe(e.color??$c)}},null)]),t.createElementVNode("div",{class:"v-color-picker-preview__sliders"},[t.createVNode(ed,{class:"v-color-picker-preview__track v-color-picker-preview__hue","aria-label":l("$vuetify.colorPicker.ariaLabel.hueSlider"),modelValue:e.color?.h,"onUpdate:modelValue":t=>a("update:color",{...e.color??$c,h:t}),step:1,min:0,max:360,disabled:e.disabled,readonly:e.readonly,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null),!e.hideAlpha&&t.createVNode(ed,{class:"v-color-picker-preview__track v-color-picker-preview__alpha","aria-label":l("$vuetify.colorPicker.ariaLabel.alphaSlider"),modelValue:e.color?.a??1,"onUpdate:modelValue":t=>a("update:color",{...e.color??$c,a:t}),step:.01,min:0,max:1,disabled:e.disabled,readonly:e.readonly,thumbSize:14,trackSize:8,trackFillColor:"white",hideDetails:!0},null)])])),{}}})
var ld={red:{base:"#f44336",lighten5:"#ffebee",lighten4:"#ffcdd2",lighten3:"#ef9a9a",lighten2:"#e57373",lighten1:"#ef5350",darken1:"#e53935",darken2:"#d32f2f",darken3:"#c62828",darken4:"#b71c1c",accent1:"#ff8a80",accent2:"#ff5252",accent3:"#ff1744",accent4:"#d50000"},pink:{base:"#e91e63",lighten5:"#fce4ec",lighten4:"#f8bbd0",lighten3:"#f48fb1",lighten2:"#f06292",lighten1:"#ec407a",darken1:"#d81b60",darken2:"#c2185b",darken3:"#ad1457",darken4:"#880e4f",accent1:"#ff80ab",accent2:"#ff4081",accent3:"#f50057",accent4:"#c51162"},purple:{base:"#9c27b0",lighten5:"#f3e5f5",lighten4:"#e1bee7",lighten3:"#ce93d8",lighten2:"#ba68c8",lighten1:"#ab47bc",darken1:"#8e24aa",darken2:"#7b1fa2",darken3:"#6a1b9a",darken4:"#4a148c",accent1:"#ea80fc",accent2:"#e040fb",accent3:"#d500f9",accent4:"#aa00ff"},deepPurple:{base:"#673ab7",lighten5:"#ede7f6",lighten4:"#d1c4e9",lighten3:"#b39ddb",lighten2:"#9575cd",lighten1:"#7e57c2",darken1:"#5e35b1",darken2:"#512da8",darken3:"#4527a0",darken4:"#311b92",accent1:"#b388ff",accent2:"#7c4dff",accent3:"#651fff",accent4:"#6200ea"},indigo:{base:"#3f51b5",lighten5:"#e8eaf6",lighten4:"#c5cae9",lighten3:"#9fa8da",lighten2:"#7986cb",lighten1:"#5c6bc0",darken1:"#3949ab",darken2:"#303f9f",darken3:"#283593",darken4:"#1a237e",accent1:"#8c9eff",accent2:"#536dfe",accent3:"#3d5afe",accent4:"#304ffe"},blue:{base:"#2196f3",lighten5:"#e3f2fd",lighten4:"#bbdefb",lighten3:"#90caf9",lighten2:"#64b5f6",lighten1:"#42a5f5",darken1:"#1e88e5",darken2:"#1976d2",darken3:"#1565c0",darken4:"#0d47a1",accent1:"#82b1ff",accent2:"#448aff",accent3:"#2979ff",accent4:"#2962ff"},lightBlue:{base:"#03a9f4",lighten5:"#e1f5fe",lighten4:"#b3e5fc",lighten3:"#81d4fa",lighten2:"#4fc3f7",lighten1:"#29b6f6",darken1:"#039be5",darken2:"#0288d1",darken3:"#0277bd",darken4:"#01579b",accent1:"#80d8ff",accent2:"#40c4ff",accent3:"#00b0ff",accent4:"#0091ea"},cyan:{base:"#00bcd4",lighten5:"#e0f7fa",lighten4:"#b2ebf2",lighten3:"#80deea",lighten2:"#4dd0e1",lighten1:"#26c6da",darken1:"#00acc1",darken2:"#0097a7",darken3:"#00838f",darken4:"#006064",accent1:"#84ffff",accent2:"#18ffff",accent3:"#00e5ff",accent4:"#00b8d4"},teal:{base:"#009688",lighten5:"#e0f2f1",lighten4:"#b2dfdb",lighten3:"#80cbc4",lighten2:"#4db6ac",lighten1:"#26a69a",darken1:"#00897b",darken2:"#00796b",darken3:"#00695c",darken4:"#004d40",accent1:"#a7ffeb",accent2:"#64ffda",accent3:"#1de9b6",accent4:"#00bfa5"},green:{base:"#4caf50",lighten5:"#e8f5e9",lighten4:"#c8e6c9",lighten3:"#a5d6a7",lighten2:"#81c784",lighten1:"#66bb6a",darken1:"#43a047",darken2:"#388e3c",darken3:"#2e7d32",darken4:"#1b5e20",accent1:"#b9f6ca",accent2:"#69f0ae",accent3:"#00e676",accent4:"#00c853"},lightGreen:{base:"#8bc34a",lighten5:"#f1f8e9",lighten4:"#dcedc8",lighten3:"#c5e1a5",lighten2:"#aed581",lighten1:"#9ccc65",darken1:"#7cb342",darken2:"#689f38",darken3:"#558b2f",darken4:"#33691e",accent1:"#ccff90",accent2:"#b2ff59",accent3:"#76ff03",accent4:"#64dd17"},lime:{base:"#cddc39",lighten5:"#f9fbe7",lighten4:"#f0f4c3",lighten3:"#e6ee9c",lighten2:"#dce775",lighten1:"#d4e157",darken1:"#c0ca33",darken2:"#afb42b",darken3:"#9e9d24",darken4:"#827717",accent1:"#f4ff81",accent2:"#eeff41",accent3:"#c6ff00",accent4:"#aeea00"},yellow:{base:"#ffeb3b",lighten5:"#fffde7",lighten4:"#fff9c4",lighten3:"#fff59d",lighten2:"#fff176",lighten1:"#ffee58",darken1:"#fdd835",darken2:"#fbc02d",darken3:"#f9a825",darken4:"#f57f17",accent1:"#ffff8d",accent2:"#ffff00",accent3:"#ffea00",accent4:"#ffd600"},amber:{base:"#ffc107",lighten5:"#fff8e1",lighten4:"#ffecb3",lighten3:"#ffe082",lighten2:"#ffd54f",lighten1:"#ffca28",darken1:"#ffb300",darken2:"#ffa000",darken3:"#ff8f00",darken4:"#ff6f00",accent1:"#ffe57f",accent2:"#ffd740",accent3:"#ffc400",accent4:"#ffab00"},orange:{base:"#ff9800",lighten5:"#fff3e0",lighten4:"#ffe0b2",lighten3:"#ffcc80",lighten2:"#ffb74d",lighten1:"#ffa726",darken1:"#fb8c00",darken2:"#f57c00",darken3:"#ef6c00",darken4:"#e65100",accent1:"#ffd180",accent2:"#ffab40",accent3:"#ff9100",accent4:"#ff6d00"},deepOrange:{base:"#ff5722",lighten5:"#fbe9e7",lighten4:"#ffccbc",lighten3:"#ffab91",lighten2:"#ff8a65",lighten1:"#ff7043",darken1:"#f4511e",darken2:"#e64a19",darken3:"#d84315",darken4:"#bf360c",accent1:"#ff9e80",accent2:"#ff6e40",accent3:"#ff3d00",accent4:"#dd2c00"},brown:{base:"#795548",lighten5:"#efebe9",lighten4:"#d7ccc8",lighten3:"#bcaaa4",lighten2:"#a1887f",lighten1:"#8d6e63",darken1:"#6d4c41",darken2:"#5d4037",darken3:"#4e342e",darken4:"#3e2723"},blueGrey:{base:"#607d8b",lighten5:"#eceff1",lighten4:"#cfd8dc",lighten3:"#b0bec5",lighten2:"#90a4ae",lighten1:"#78909c",darken1:"#546e7a",darken2:"#455a64",darken3:"#37474f",darken4:"#263238"},grey:{base:"#9e9e9e",lighten5:"#fafafa",lighten4:"#f5f5f5",lighten3:"#eeeeee",lighten2:"#e0e0e0",lighten1:"#bdbdbd",darken1:"#757575",darken2:"#616161",darken3:"#424242",darken4:"#212121"},shades:{black:"#000000",white:"#ffffff",transparent:"#ffffff00"}}
const nd=rt({swatches:{type:Array,default:()=>function(e){return Object.keys(e).map(t=>{const a=e[t]
return a.base?[a.base,a.darken4,a.darken3,a.darken2,a.darken1,a.lighten1,a.lighten2,a.lighten3,a.lighten4,a.lighten5]:[a.black,a.white,a.transparent]})}(ld)},disabled:Boolean,readonly:Boolean,color:Object,maxHeight:[Number,String],...it()},"VColorPickerSwatches")
const od=mt({name:"VColorPickerSwatches",props:nd(),emits:{"update:color":e=>!0},setup(e,{emit:a}){const l=t.toRef(()=>!e.disabled&&!e.readonly)
...
return t.onBeforeMount(()=>{e.modes.includes(n.value)||(n.value=e.modes[0])}),vt({VSlider:{color:null,trackColor:null,trackFillColor:null}}),It(()=>{const a=sd.filterProps(e)
return t.createVNode(sd,t.mergeProps(a,{class:["v-color-picker",s.value,e.class],style:[{"--v-color-picker-color-hsv":Xe({...i.value??$c,a:1})},e.style]}),{...l,default:()=>t.createElementVNode(t.Fragment,null,[!e.hideCanvas&&t.createVNode(Fc,{key:"canvas",color:i.value,"onUpdate:color":c,disabled:e.disabled,readonly:e.readonly,dotSize:e.dotSize,width:e.width,height:e.canvasHeight},null),(!e.hideSliders||!e.hideInputs)&&t.createElementVNode("div",{key:"controls",class:"v-color-picker__controls"},[!e.hideSliders&&t.createVNode(ad,{key:"preview",color:i.value,"onUpdate:color":c,hideAlpha:!n.value.endsWith("a"),disabled:e.disabled,readonly:e.readonly,hideEyeDropper:e.hideEyeDropper,eyeDropperIcon:e.eyeDropperIcon},null),!e.hideInputs&&t.createVNode(Hc,{key:"edit",modes:e.modes,mode:n.value,"onUpdate:mode":e=>n.value=e,color:i.value,"onUpdate:color":c,disabled:e.disabled,readonly:e.readonly},null)]),e.showSwatches&&t.createVNode(od,{key:"swatches",color:i.value,"onUpdate:color":c,maxHeight:e.swatchesMaxHeight,swatches:e.swatches,disabled:e.disabled,readonly:e.readonly},null)])})}),{}}}),cd=rt({alwaysFilter:Boolean,autoSelectFirst:{type:[Boolean,String]},clearOnSelect:{type:Boolean,default:!0},delimiters:Array,...es({filterKeys:["title"]}),...os({hideNoData:!0,returnObject:!0}),...x(ji({modelValue:null,role:"combobox"}),["validationValue","dirty"])},"VCombobox"),dd=ft()({name:"VCombobox",props:cd(),emits:{"update:focused":e=>!0,"update:modelValue":e=>!0,"update:search":e=>!0,"update:menu":e=>!0},setup(e,{emit:a,slots:l}){const{t:n}=sa(),r=t.ref(),i=t.shallowRef(!1),s=t.shallowRef(!0),u=t.shallowRef(!1),c=t.ref(),d=t.ref(),v=t.shallowRef(-1)
let p=!1
...
e.length>1&&(se(e),N.value="")}a||(v.value=-1),s.value=!a}}),_=t.computed(()=>"function"==typeof e.counterValue?e.counterValue(V.value):"number"==typeof e.counterValue?e.counterValue:e.multiple?V.value.length:E.value.length),{filteredItems:R,getMatches:A}=ts(e,m,()=>C.value??(e.alwaysFilter||!s.value?E.value:"")),D=t.computed(()=>e.hideSelected&&null===C.value?R.value.filter(e=>!V.value.some(t=>t.value===e.value)):R.value),T=t.computed(()=>e.hideNoData&&!D.value.length||w.isReadonly.value||w.isDisabled.value),B=Zt(e,"menu"),F=t.computed({get:()=>B.value,set:e=>{B.value&&!e&&c.value?.ΨopenChildren.size||e&&T.value||(B.value=e)}}),{menuId:$,ariaExpanded:M,ariaControls:z}=ns(0,F)
...
const L=t.computed(()=>V.value.map(e=>e.value)),O=t.computed(()=>D.value.find(e=>"item"===e.type&&!e.props.disabled)),j=t.computed(()=>(!0===e.autoSelectFirst||"exact"===e.autoSelectFirst&&E.value===O.value?.title)&&D.value.length>0&&!s.value&&!u.value),H=t.ref(),W=t.ref(),Y=t.ref(),U=Xi(H,r),{onTabKeydown:G}=Zi({groups:[{type:"element",contentRef:W},{type:"list",contentRef:H,displayItemsCount:()=>D.value.length},{type:"element",contentRef:Y}],onLeave:()=>{F.value=!1,r.value?.focus()}})
...
return It(()=>t.createElementVNode(t.Fragment,null,[l.default?.({model:o,save:d,cancel:v,isPristine:i.value,get actions(){return m=!0,p}}),!e.hideActions&&!m&&p()])),{save:d,cancel:v,isPristine:i}}}),md=rt({expandOnClick:Boolean,showExpand:Boolean,expanded:{type:Array,default:()=>[]}},"DataTable-expand"),fd=Symbol.for("vuetify:datatable:expanded")
function gd(e){const a=t.toRef(()=>e.expandOnClick),l=Zt(e,"expanded",e.expanded,e=>new Set(e),e=>[...e.values()])
...
return t.provide(fd,r),r}function hd(){const e=t.inject(fd)
if(!e)throw new Error("foo")
return e}const yd=rt({groupBy:{type:Array,default:()=>[]}},"DataTable-group"),bd=Symbol.for("vuetify:data-table-group")
function Vd(e){return{groupBy:Zt(e,"groupBy")}}function wd(e){const{disableSort:a,groupBy:l,sortBy:n}=e,o=t.ref(new Set)
...
return t.provide(bd,i),i}function Sd(){const e=t.inject(bd)
if(!e)throw new Error("Missing group!")
return e}function kd(e,t,a=0,l="root"){if(!t.length)return[]
...
o.push({depth:a,id:s,key:i,value:n,items:r.length?kd(e,r,a+1,s):e,type:"group"})}),o}function xd(e,t,a){const l=[]
for(const n of e)"type"in n&&"group"===n.type?(null!=n.value&&l.push(n),(t.has(n.id)||null==n.value)&&(l.push(...xd(n.items,t,a)),a&&l.push({...n,type:"group-summary"}))):l.push(n)
return l}function Nd(e,a,l,n){const o=t.computed(()=>a.value.length?kd(t.toValue(e),a.value.map(e=>e.key)):[]),r=t.computed(()=>a.value.length?xd(o.value,l.value,t.toValue(n)):t.toValue(e))
return{groups:o,flatItems:r}}function Cd({page:e,itemsPerPage:a,sortBy:l,groupBy:n,search:o}){const r=st("VDataTable")
let i=null
t.watch(()=>({page:e.value,itemsPerPage:a.value,sortBy:l.value,groupBy:n.value,search:o.value}),t=>{ht(i,t)||(i&&i.search!==t.search&&(e.value=1),r.emit("update:options",t),i=t)},{deep:!0,immediate:!0})}const Ed=rt({page:{type:[Number,String],default:1},itemsPerPage:{type:[Number,String],default:10},pageBy:{type:String,default:"any"}},"DataTable-paginate"),Id=Symbol.for("vuetify:data-table-pagination")
function _d(e){return{page:Zt(e,"page",void 0,e=>Number(e??1)),itemsPerPage:Zt(e,"itemsPerPage",void 0,e=>Number(e??10))}}function Pd(e){const{page:a,itemsPerPage:l,itemsLength:n}=e,o=t.computed(()=>-1===l.value?0:l.value*(a.value-1)),r=t.computed(()=>-1===l.value?n.value:Math.min(n.value,o.value+l.value)),i=t.computed(()=>-1===l.value||0===n.value?1:Math.ceil(n.value/l.value))
...
return t.provide(Id,s),s}function Rd(e){const a=st("usePaginatedItems"),{items:l,startIndex:n,stopIndex:o,itemsPerPage:r}=e,i=t.computed(()=>r.value<=0?t.toValue(l):t.toValue(l).slice(n.value,o.value))
return t.watch(i,e=>{a.emit("update:currentItems",e)},{immediate:!0}),{paginatedItems:i}}const Ad={showSelectAll:!1,allSelected:()=>[],select:({items:e,value:t})=>new Set(t?[e[0]?.value]:[]),selectAll:({selected:e})=>e},Dd={showSelectAll:!0,allSelected:({currentPage:e})=>e,select:({items:e,value:t,selected:a})=>{for(const l of e)t?a.add(l.value):a.delete(l.value)
return a},selectAll:({value:e,currentPage:t,selected:a})=>Dd.select({items:t,value:e,selected:a})},Td={showSelectAll:!0,allSelected:({allItems:e})=>e,select:({items:e,value:t,selected:a})=>{for(const l of e)t?a.add(l.value):a.delete(l.value)
return a},selectAll:({value:e,allItems:t})=>new Set(e?t.map(e=>e.value):[])},Bd=rt({showSelect:Boolean,selectStrategy:{type:[String,Object],default:"page"},modelValue:{type:Array,default:()=>[]},valueComparator:Function},"DataTable-select"),Fd=Symbol.for("vuetify:data-table-selection")
function $d(e,{allItems:a,currentPage:l}){const n=Zt(e,"modelValue",e.modelValue,t=>{const l=e.valueComparator
...
switch(e.selectStrategy){case"single":return Ad
case"all":return Td
default:return Dd}}),s=t.shallowRef(null)
...
return t.provide(Fd,p),p}function Md(){const e=t.inject(Fd)
if(!e)throw new Error("Missing selection!")
return e}const zd=rt({initialSortOrder:{type:String,default:"asc",validator:e=>!e||["asc","desc"].includes(e)},sortBy:{type:Array,default:()=>[]},customKeySort:Object,multiSort:{type:[Boolean,Object],default:!1},mustSort:Boolean},"DataTable-sort"),Ld=Symbol.for("vuetify:data-table-sort")
function Od(e){const a=t.toRef(()=>e.initialSortOrder),l=Zt(e,"sortBy"),n=t.toRef(()=>e.mustSort)
return{initialSortOrder:a,sortBy:l,multiSort:t.toRef(()=>e.multiSort),mustSort:n}}function jd(e){const{initialSortOrder:a,sortBy:l,mustSort:n,multiSort:o,page:r}=e
...
return t.provide(Ld,i),i}function Hd(){const e=t.inject(Ld)
if(!e)throw new Error("Missing sort!")
return e}function Wd(e,a,l,n){const o=sa(),r=t.computed(()=>l.value.length?function(e,t,a,l){const n=new Intl.Collator(a,{sensitivity:"accent",usage:"sort"}),o=e.map(e=>[e,l?.transform?l.transform(e):e])
...
return{sortedItems:r}}const Yd=rt({items:{type:Array,default:()=>[]},itemValue:{type:[String,Array,Function],default:"id"},itemSelectable:{type:[String,Array,Function],default:null},returnObject:Boolean},"DataIterator-items")
function Ud(e,t){return{type:"item",value:e.returnObject?t:p(t,e.itemValue),selectable:p(t,e.itemSelectable,!0),raw:t}}function Gd(e){const a=t.computed(()=>function(e,t){const a=[]
for(const l of t)a.push(Ud(e,l))
return a}(e,e.items))
return{items:a}}const Kd=rt({search:String,loading:Boolean,itemsLength:[Number,String],...it(),...Yd(),...Bd(),...zd(),...Ed({itemsPerPage:5}),...md(),...yd(),...es(),...xa(),...cl({transition:{component:za,hideOnLeave:!0}})},"VDataIterator"),qd=ft()({name:"VDataIterator",props:Kd(),emits:{"update:modelValue":e=>!0,"update:groupBy":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,{slots:a}){const l=Zt(e,"groupBy"),n=t.toRef(()=>e.search),{items:o}=Gd(e),{filteredItems:r}=ts(e,o,n,{transform:e=>e.raw}),{initialSortOrder:i,sortBy:s,multiSort:u,mustSort:c}=Od(e),{page:d,itemsPerPage:v}=_d(e),{toggleSort:p}=jd({initialSortOrder:i,sortBy:s,multiSort:u,mustSort:c,page:d}),{sortByWithGroups:m,opened:f,extractRows:g,isGroupOpen:h,toggleGroup:y}=wd({groupBy:l,sortBy:s}),{sortedItems:b}=Wd(e,r,m,{transform:e=>e.raw}),{flatItems:V}=Nd(b,l,f,!1),w=t.toRef(()=>!Z(e.itemsLength)),S=t.toRef(()=>w.value?Number(e.itemsLength):V.value.length),{startIndex:k,stopIndex:x,pageCount:N,prevPage:C,nextPage:E,setItemsPerPage:I,setPage:_}=Pd({page:d,itemsPerPage:v,itemsLength:S}),P=t.shallowRef([]),R=t.computed(()=>w.value?V.value:P.value)
Xt(()=>!w.value,()=>{const{paginatedItems:e}=Rd({items:V,startIndex:k,stopIndex:x,itemsPerPage:v})
t.watchEffect(()=>{P.value=e.value})})
const A=t.computed(()=>g(R.value)),{isSelected:D,select:T,selectAll:B,toggleSelect:F}=$d(e,{allItems:o,currentPage:A}),{isExpanded:$,toggleExpand:M}=gd(e)
Cd({page:d,itemsPerPage:v,sortBy:s,groupBy:l,search:n})
...
return It(()=>{const v=Zd.filterProps(e)
return t.createElementVNode("div",{class:"v-data-table-footer"},[a.prepend?.(),t.createElementVNode("div",{class:"v-data-table-footer__items-per-page"},[t.createElementVNode("span",null,[l(e.itemsPerPageText)]),t.createVNode(is,{items:d.value,itemColor:e.color,modelValue:u.value,"onUpdate:modelValue":e=>c(Number(e)),density:"compact",variant:"outlined","aria-label":l(e.itemsPerPageText),hideDetails:!0},null)]),t.createElementVNode("div",{class:"v-data-table-footer__info"},[t.createElementVNode("div",null,[l(e.pageText,s.value?r.value+1:0,i.value,s.value)])]),t.createElementVNode("div",{class:"v-data-table-footer__pagination"},[t.createVNode(Zd,t.mergeProps({modelValue:n.value,"onUpdate:modelValue":e=>n.value=e,density:"comfortable",firstAriaLabel:e.firstPageLabel,lastAriaLabel:e.lastPageLabel,length:o.value,nextAriaLabel:e.nextPageLabel,previousAriaLabel:e.prevPageLabel,rounded:!0,showFirstLastPage:!0,totalVisible:e.showCurrentPage?1:0,variant:"plain"},x(v,["color"])),null)])])}),{}}}),ev=(tv={align:{type:String,default:"start"},fixed:{type:[Boolean,String],default:!1},fixedOffset:[Number,String],fixedEndOffset:[Number,String],height:[Number,String],lastFixed:Boolean,firstFixedEnd:Boolean,noPadding:Boolean,indent:[Number,String],empty:Boolean,tag:String,width:[Number,String],maxWidth:[Number,String],nowrap:Boolean},av=(e,{slots:a})=>{const l=e.tag??"td",n="string"==typeof e.fixed?e.fixed:e.fixed?"start":"none"
return t.createVNode(l,{class:t.normalizeClass(["v-data-table__td",{"v-data-table-column--fixed":"start"===n,"v-data-table-column--fixed-end":"end"===n,"v-data-table-column--last-fixed":e.lastFixed,"v-data-table-column--first-fixed-end":e.firstFixedEnd,"v-data-table-column--no-padding":e.noPadding,"v-data-table-column--nowrap":e.nowrap,"v-data-table-column--empty":e.empty},`v-data-table-column--align-${e.align}`]),style:{height:f(e.height),width:f(e.width),maxWidth:f(e.maxWidth),left:"start"===n?f(e.fixedOffset||null):void 0,right:"end"===n?f(e.fixedEndOffset||null):void 0,paddingInlineStart:e.indent?f(e.indent):void 0}},{default:()=>[a.default?.()]})},av.props=tv,av)
var tv,av
const lv=rt({headers:Array},"DataTable-header"),nv=Symbol.for("vuetify:data-table-headers"),ov={title:"",sortable:!1},rv={...ov,width:48}
function iv(e,t=[]){if(e.children)for(const a of e.children)iv(a,t)
else t.push(e)
return t}function sv(e,t=new Set){for(const a of e)a.key&&t.add(a.key),a.children&&sv(a.children,t)
return t}function uv(e){if(e.key)return"data-table-group"===e.key?ov:["data-table-expand","data-table-select"].includes(e.key)?rv:void 0}function cv(e,t=0){return e.children?Math.max(t,...e.children.map(e=>cv(e,t+1))):t}function dv(e,t=0){if(!e)return t
if(e.children){e.fixedOffset=t
for(const a of e.children)t=dv(a,t)}else e.fixed&&"end"!==e.fixed&&(e.fixedOffset=t,t+=parseFloat(e.width||"0")||0)
return t}function vv(e,t=0){if(!e)return t
...
return t}function pv(e,t){const a=[]
let l=0
...
const o=[]
let r=1
for(;e>0;){const{element:a,priority:i}=n.dequeue(),s=t-l-cv(a)
if(o.push({...a,rowspan:s??1,colspan:a.children?iv(a).length:1}),a.children)for(const e of a.children){const t=i%1+r/Math.pow(10,l+2)
n.enqueue(e,l+s+t)}r+=1,e-=1}l+=1,a.push(o)}return{columns:e.map(e=>iv(e)).flat(),headers:a}}function mv(e){const t=[]
for(const a of e){const e={...uv(a),...a},l=e.key??("string"==typeof e.value?e.value:null),n=e.value??l??null,o={...e,key:l,value:n,sortable:e.sortable??(null!=e.key||!!e.sort),children:e.children?mv(e.children):void 0}
t.push(o)}return t}function fv(e,a){const n=t.ref([]),o=t.ref([]),r=t.ref({}),i=t.ref({}),s=t.ref({})
t.watchEffect(()=>{const u=(e.headers||Object.keys(e.items[0]??{}).map(e=>({key:e,title:t.capitalize(e)}))).slice(),c=sv(u)
...
let n=0
for(let t=0;t<e.length;t++)n=dv(e[t],n)
let o=0
for(let t=e.length-1;t>=0;t--)o=vv(e[t],o)}(d)
const v=Math.max(...d.map(e=>cv(e)))+1,p=pv(d,v)
...
return t.provide(nv,u),u}function gv(){const e=t.inject(nv)
if(!e)throw new Error("Missing headers!")
return e}const hv=rt({color:String,disableSort:Boolean,fixedHeader:Boolean,multiSort:Boolean,initialSortOrder:String,sortIcon:{type:_t},sortAscIcon:{type:_t,default:"$sortAsc"},sortDescIcon:{type:_t,default:"$sortDesc"},headerProps:{type:Object},sticky:Boolean,...Al(),...Po(),...rn()},"VDataTableHeaders"),yv=ft()({name:"VDataTableHeaders",props:hv(),setup(e,{slots:a}){const{t:l}=sa(),{toggleSort:n,sortBy:o,isSorted:r}=Hd(),{someSelected:i,allSelected:s,selectAll:u,showSelectAll:c}=Md(),{columns:d,headers:v}=gv(),{loaderClasses:p}=sn(e)
...
return a["data-table-group"]?.({item:e.item,count:c.value.length,props:{icon:o,onClick:r}})??t.createVNode(ev,{class:"v-data-table-group-header-row__column",colspan:d.value},{default:()=>[t.createVNode(Tn,{size:"small",variant:"text",icon:o,onClick:r},null),t.createElementVNode("span",null,[e.item.value]),t.createElementVNode("span",null,[t.createTextVNode("("),c.value.length,t.createTextVNode(")")])]})}if("data-table-select"===o.key){const l=c.value.filter(e=>e.selectable),n=l.length>0&&r(l),o=i(l)&&!n,u=e=>s(l,e)
return a["data-table-select"]?.({props:{modelValue:n,indeterminate:o,"onUpdate:modelValue":u}})??t.createVNode(ev,{class:"v-data-table__td--select-row",noPadding:!0},{default:()=>[t.createVNode(lo,{density:e.density,disabled:0===l.length,modelValue:n,indeterminate:o,"onUpdate:modelValue":u},null)]})}return""})])}}),wv=rt({color:String,index:Number,item:Object,cellProps:[Object,Function],collapseIcon:{type:_t,default:"$collapse"},expandIcon:{type:_t,default:"$expand"},onClick:Y(),onContextmenu:Y(),onDblclick:Y(),...Al(),...Po()},"VDataTableRow"),Sv=ft()({name:"VDataTableRow",props:wv(),setup(e,{slots:a}){const{displayClasses:l,mobile:n}=Ro(e,"v-data-table__tr"),{isSelected:o,toggleSelect:r,someSelected:i,allSelected:s,selectAll:u}=Md(),{isExpanded:c,toggleExpand:d}=hd(),{toggleSort:p,sortBy:m,isSorted:f}=Hd(),{columns:g}=gv()
...
return n.value?t.createElementVNode(t.Fragment,null,[t.createElementVNode("div",{class:"v-data-table__td-title"},[a[b]?.(w)??l.title]),t.createElementVNode("div",{class:"v-data-table__td-value"},[a[y]?.(V)??i])]):i}})})]))}}),kv=rt({color:String,loading:[Boolean,String],loadingText:{type:String,default:"$vuetify.dataIterator.loadingText"},hideNoData:Boolean,items:{type:Array,default:()=>[]},noDataText:{type:String,default:"$vuetify.noDataText"},rowProps:[Object,Function],cellProps:[Object,Function],...S(wv(),["collapseIcon","expandIcon","density"]),...S(bv(),["groupCollapseIcon","groupExpandIcon","density"]),...Po()},"VDataTableRows"),xv=ft()({name:"VDataTableRows",inheritAttrs:!1,props:kv(),setup(e,{attrs:a,slots:l}){const{columns:n}=gv(),{expandOnClick:o,toggleExpand:r,isExpanded:i}=hd(),{isSelected:s,toggleSelect:u}=Md(),{toggleGroup:c,isGroupOpen:d}=Sd(),{t:v}=sa(),{mobile:p}=Ro(e)
...
return l["group-header"]?l["group-header"](e):t.createVNode(Vv,t.mergeProps({key:`group-header_${v.id}`,item:v},kt(a,":groupHeader",()=>e),m),l)}if("group-summary"===v.type){const e={index:f,item:v,columns:n.value,toggleGroup:c}
...
return t.createElementVNode(t.Fragment,{key:h.props.key},[l.item?l.item(h):t.createVNode(Sv,h.props,l),i(v)&&l["expanded-row"]?.(g)])})]):t.createElementVNode("tr",{class:"v-data-table-rows-no-data",key:"no-data"},[t.createElementVNode("td",{colspan:n.value.length},[l["no-data"]?.()??v(e.noDataText)])]):t.createElementVNode("tr",{class:"v-data-table-rows-loading",key:"loading"},[t.createElementVNode("td",{colspan:n.value.length},[l.loading?.()??v(e.loadingText)])])}),{}}}),Nv=rt({fixedHeader:Boolean,fixedFooter:Boolean,height:[Number,String],hover:Boolean,striped:{type:String,default:null,validator:e=>["even","odd"].includes(e)},...it(),...Al(),...xa(),...va()},"VTable"),Cv=ft()({name:"VTable",props:Nv(),setup(e,{slots:a,emit:l}){const{themeClasses:n}=Va(e),{densityClasses:o}=Dl(e)
...
function Iv(e,t,a){return t.map((t,l)=>function(e,t,a,l){const n=e.returnObject?t:p(t,e.itemValue),o=p(t,e.itemSelectable,!0),r=l.reduce((e,a)=>(null!=a.key&&(e[a.key]=p(t,a.value)),e),{})
return{type:"item",key:e.returnObject?p(t,e.itemValue):n,index:a,value:n,selectable:o,columns:r,raw:t}}(e,t,l,a))}function _v(e,a){return{items:t.computed(()=>Iv(e,e.items,a.value))}}const Pv=rt({...kv(),hideDefaultBody:Boolean,hideDefaultFooter:Boolean,hideDefaultHeader:Boolean,width:[String,Number],search:String,...md(),...yd(),...lv(),...Ev(),...Bd(),...zd(),...x(hv(),["multiSort","initialSortOrder"]),...Nv()},"DataTable"),Rv=rt({...Ed(),...Pv(),...es(),...Qd()},"VDataTable"),Av=ft()({name:"VDataTable",props:Rv(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0,"update:currentItems":e=>!0},setup(e,{attrs:a,slots:l}){const{groupBy:n}=Vd(e),{initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}=Od(e),{page:u,itemsPerPage:c}=_d(e),{disableSort:d}=t.toRefs(e),{columns:v,headers:p,sortFunctions:m,sortRawFunctions:f,filterFunctions:g}=fv(e,{groupBy:n,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:h}=_v(e,v),y=t.toRef(()=>e.search),{filteredItems:b}=ts(e,h,y,{transform:e=>e.columns,customKeyFilter:g}),{toggleSort:V}=jd({initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s,page:u}),{sortByWithGroups:w,opened:S,extractRows:k,isGroupOpen:N,toggleGroup:C}=wd({groupBy:n,sortBy:r,disableSort:d}),{sortedItems:E}=Wd(e,b,w,{transform:e=>({...e.raw,...e.columns}),sortFunctions:m,sortRawFunctions:f}),I=t.computed(()=>"auto"===e.pageBy?e.groupBy.length?"group":"item":e.pageBy),{pageCount:_,setItemsPerPage:P,prevPage:R,nextPage:A,setPage:D,paginatedItems:T}=function(e){const{sortedItems:a,paginate:l,group:n}=e,o=t.toValue(e.pageBy)
...
return{pageCount:o,setItemsPerPage:r,prevPage:i,nextPage:s,setPage:u,paginatedItems:t}}throw new Error(`Unrecognized pagination target ${o}`)}({pageBy:I,sortedItems:E,paginate:e=>{const a=t.computed(()=>t.toValue(e).length),{startIndex:l,stopIndex:n,pageCount:o,setItemsPerPage:r,prevPage:i,nextPage:s,setPage:d}=Pd({page:u,itemsPerPage:c,itemsLength:a}),{paginatedItems:v}=Rd({items:e,startIndex:l,stopIndex:n,itemsPerPage:c})
return{paginatedItems:v,pageCount:o,setItemsPerPage:r,prevPage:i,nextPage:s,setPage:d}},group:e=>Nd(e,n,S,()=>!!l["group-summary"])}),B=t.computed(()=>k(T.value)),{isSelected:F,select:$,selectAll:M,toggleSelect:z,someSelected:L,allSelected:O}=$d(e,{allItems:h,currentPage:B}),{isExpanded:j,toggleExpand:H}=gd(e)
Cd({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:y}),vt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
const W=t.computed(()=>({page:u.value,itemsPerPage:c.value,sortBy:r.value,pageCount:_.value,toggleSort:V,setItemsPerPage:P,prevPage:R,nextPage:A,setPage:D,someSelected:L.value,allSelected:O.value,isSelected:F,select:$,selectAll:M,toggleSelect:z,isExpanded:j,toggleExpand:H,isGroupOpen:N,toggleGroup:C,items:B.value.map(e=>e.raw),internalItems:B.value,groupedItems:T.value,columns:v.value,headers:p.value}))
return It(()=>{const n=Jd.filterProps(e),o=yv.filterProps(x(e,["multiSort"])),r=xv.filterProps(e),i=Cv.filterProps(e)
return t.createVNode(Cv,t.mergeProps({class:["v-data-table",{"v-data-table--show-select":e.showSelect,"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>l.top?.(W.value),default:()=>l.default?l.default(W.value):t.createElementVNode(t.Fragment,null,[l.colgroup?.(W.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(yv,t.mergeProps(o,{multiSort:!!e.multiSort}),l)]),l.thead?.(W.value),!e.hideDefaultBody&&t.createElementVNode("tbody",null,[l["body.prepend"]?.(W.value),l.body?l.body(W.value):t.createVNode(xv,t.mergeProps(a,r,{items:T.value}),l),l["body.append"]?.(W.value)]),l.tbody?.(W.value),l.tfoot?.(W.value)]),bottom:()=>l.bottom?l.bottom(W.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(Zo,null,null),t.createVNode(Jd,n,{prepend:l["footer.prepend"]})])})}),{}}}),Dv=rt({...x(Pv(),["hideDefaultFooter"]),...yd(),...Ui(),...es()},"VDataTableVirtual"),Tv=ft()({name:"VDataTableVirtual",props:Dv(),emits:{"update:modelValue":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:groupBy":e=>!0,"update:expanded":e=>!0},setup(e,{attrs:a,slots:l}){const{groupBy:n}=Vd(e),{initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}=Od(e),{disableSort:u}=t.toRefs(e),{columns:c,headers:d,filterFunctions:v,sortFunctions:p,sortRawFunctions:m}=fv(e,{groupBy:n,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:g}=_v(e,c),h=t.toRef(()=>e.search),{filteredItems:y}=ts(e,g,h,{transform:e=>e.columns,customKeyFilter:v}),{toggleSort:b}=jd({initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}),{sortByWithGroups:V,opened:w,extractRows:S,isGroupOpen:k,toggleGroup:N}=wd({groupBy:n,sortBy:r,disableSort:u}),{sortedItems:C}=Wd(e,y,V,{transform:e=>({...e.raw,...e.columns}),sortFunctions:p,sortRawFunctions:m}),{flatItems:E}=Nd(C,n,w,()=>!!l["group-summary"]),I=t.computed(()=>S(E.value)),{isSelected:_,select:P,selectAll:R,toggleSelect:A,someSelected:D,allSelected:T}=$d(e,{allItems:I,currentPage:I}),{isExpanded:B,toggleExpand:F}=gd(e),{containerRef:$,markerRef:M,paddingTop:z,paddingBottom:L,computedItems:O,handleItemResize:j,handleScroll:H,handleScrollend:W,calculateVisibleItems:Y,scrollToIndex:U}=Gi(e,E),G=t.computed(()=>O.value.map(e=>({...e.raw,virtualIndex:e.index})))
Cd({sortBy:r,page:t.shallowRef(1),itemsPerPage:t.shallowRef(-1),groupBy:n,search:h}),vt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
...
return It(()=>{const n=yv.filterProps(x(e,["multiSort"])),o=xv.filterProps(e),r=Cv.filterProps(e)
return t.createVNode(Cv,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},r,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>l.top?.(K.value),wrapper:()=>t.createElementVNode("div",{ref:$,onScrollPassive:H,onScrollend:W,class:"v-table__wrapper",style:{height:f(e.height)}},[t.createElementVNode("table",null,[l.colgroup?.(K.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead"},[t.createVNode(yv,t.mergeProps(n,{multiSort:!!e.multiSort}),l)]),l.thead?.(K.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{key:"tbody"},[t.createElementVNode("tr",{ref:M,style:{height:f(z.value),border:0}},[t.createElementVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)]),l["body.prepend"]?.(K.value),t.createVNode(xv,t.mergeProps(a,o,{items:G.value}),{...l,item:e=>t.createVNode(Yi,{key:e.internalItem.index,renderless:!0,"onUpdate:height":t=>j(e.internalItem.index,t)},{default:({itemRef:a})=>l.item?.({...e,itemRef:a})??t.createVNode(Sv,t.mergeProps(e.props,{ref:a,key:e.internalItem.index,index:e.index}),l)})}),l["body.append"]?.(K.value),t.createElementVNode("tr",{style:{height:f(L.value),border:0}},[t.createElementVNode("td",{colspan:c.value.length,style:{height:0,border:0}},null)])]),l.tbody?.(K.value),l.tfoot?.(K.value)])]),bottom:()=>l.bottom?.(K.value)})}),{calculateVisibleItems:Y,scrollToIndex:U}}}),Bv=rt({itemsLength:{type:[Number,String],required:!0},...Ed(),...Pv(),...Qd()},"VDataTableServer"),Fv=ft()({name:"VDataTableServer",props:Bv(),emits:{"update:modelValue":e=>!0,"update:page":e=>!0,"update:itemsPerPage":e=>!0,"update:sortBy":e=>!0,"update:options":e=>!0,"update:expanded":e=>!0,"update:groupBy":e=>!0},setup(e,{attrs:a,slots:l}){const{groupBy:n}=Vd(e),{initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s}=Od(e),{page:u,itemsPerPage:c}=_d(e),{disableSort:d}=t.toRefs(e),v=t.computed(()=>parseInt(e.itemsLength,10)),{columns:p,headers:m}=fv(e,{groupBy:n,showSelect:t.toRef(()=>e.showSelect),showExpand:t.toRef(()=>e.showExpand)}),{items:f}=_v(e,p),{toggleSort:g}=jd({initialSortOrder:o,sortBy:r,multiSort:i,mustSort:s,page:u}),{opened:h,isGroupOpen:y,toggleGroup:b,extractRows:V}=wd({groupBy:n,sortBy:r,disableSort:d}),{pageCount:w,setItemsPerPage:S,prevPage:k,nextPage:N,setPage:C}=Pd({page:u,itemsPerPage:c,itemsLength:v}),{flatItems:E}=Nd(f,n,h,()=>!!l["group-summary"]),{isSelected:I,select:_,selectAll:P,toggleSelect:R,someSelected:A,allSelected:D}=$d(e,{allItems:f,currentPage:f}),{isExpanded:T,toggleExpand:B}=gd(e),F=t.computed(()=>V(f.value))
Cd({page:u,itemsPerPage:c,sortBy:r,groupBy:n,search:t.toRef(()=>e.search)}),t.provide("v-data-table",{toggleSort:g,sortBy:r}),vt({VDataTableRows:{hideNoData:t.toRef(()=>e.hideNoData),noDataText:t.toRef(()=>e.noDataText),loading:t.toRef(()=>e.loading),loadingText:t.toRef(()=>e.loadingText)}})
const $=t.computed(()=>({page:u.value,itemsPerPage:c.value,sortBy:r.value,pageCount:w.value,toggleSort:g,setItemsPerPage:S,prevPage:k,nextPage:N,setPage:C,someSelected:A.value,allSelected:D.value,isSelected:I,select:_,selectAll:P,toggleSelect:R,isExpanded:T,toggleExpand:B,isGroupOpen:y,toggleGroup:b,items:F.value.map(e=>e.raw),internalItems:F.value,groupedItems:E.value,columns:p.value,headers:m.value}))
It(()=>{const n=Jd.filterProps(e),o=yv.filterProps(x(e,["multiSort"])),r=xv.filterProps(e),i=Cv.filterProps(e)
return t.createVNode(Cv,t.mergeProps({class:["v-data-table",{"v-data-table--loading":e.loading},e.class],style:e.style},i,{fixedHeader:e.fixedHeader||e.sticky}),{top:()=>l.top?.($.value),default:()=>l.default?l.default($.value):t.createElementVNode(t.Fragment,null,[l.colgroup?.($.value),!e.hideDefaultHeader&&t.createElementVNode("thead",{key:"thead",class:"v-data-table__thead",role:"rowgroup"},[t.createVNode(yv,t.mergeProps(o,{multiSort:!!e.multiSort}),l)]),l.thead?.($.value),!e.hideDefaultBody&&t.createElementVNode("tbody",{class:"v-data-table__tbody",role:"rowgroup"},[l["body.prepend"]?.($.value),l.body?l.body($.value):t.createVNode(xv,t.mergeProps(a,r,{items:E.value}),l),l["body.append"]?.($.value)]),l.tbody?.($.value),l.tfoot?.($.value)]),bottom:()=>l.bottom?l.bottom($.value):!e.hideDefaultFooter&&t.createElementVNode(t.Fragment,null,[t.createVNode(Zo,null,null),t.createVNode(Jd,n,{prepend:l["footer.prepend"]})])})})}}),$v=rt({fluid:{type:Boolean,default:!1},...it(),...el(),...xa()},"VContainer"),Mv=ft()({name:"VContainer",props:$v(),setup(e,{slots:a}){const{rtlClasses:l}=ca(),{dimensionStyles:n}=tl(e)
return It(()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-container",{"v-container--fluid":e.fluid},l.value,e.class]),style:t.normalizeStyle([n.value,e.style])},a)),{}}}),zv=ko.reduce((e,t)=>(e[t]={type:[Boolean,String,Number],default:!1},e),{}),Lv=ko.reduce((e,a)=>(e["offset"+t.capitalize(a)]={type:[String,Number],default:null},e),{}),Ov={col:V(zv),offset:V(Lv),order:["order","orderSm","orderMd","orderLg","orderXl","orderXxl"]}
function jv(e){if("string"==typeof e&&e.includes("/")){const[t,a]=e.split("/")
return{cols:Number(t),size:Number(a)}}return{cols:e}}function Hv(e,t,a){if(null==a||!1===a)return{}
const{cols:l,size:n}=jv(a),o=t.replace(e,"").toLowerCase()
return"offset"===e?{className:`v-col--offset-${o}-${l}`,variables:[{[`--v-col-offset-base-${o}`]:n}]}:"order"===e?{className:`order-${o}-${l}`}:{className:""===l||!0===l?`v-col--${o}`:`v-col--cols-${o}-${l}`,variables:[{[`--v-col-size-base-${o}`]:n}]}}const Wv=["auto","start","end","center","baseline","stretch"],Yv=rt({cols:{type:[Boolean,String,Number],default:!1},...zv,offset:{type:[String,Number],default:null},...Lv,order:{type:[String,Number],default:null},orderSm:{type:String,default:null},orderMd:{type:String,default:null},orderLg:{type:String,default:null},orderXl:{type:String,default:null},orderXxl:{type:String,default:null},alignSelf:{type:String,default:null,validator:e=>Wv.includes(e)},...it(),...xa()},"VCol"),Uv=ft()({name:"VCol",props:Yv(),setup(e,{slots:a}){const l=t.computed(()=>jv(e.cols).size),n=t.computed(()=>jv(e.offset).size),o=t.computed(()=>{const t=["v-col"],a=[]
let l
for(l in Ov)Ov[l].forEach(n=>{const o=e[n],{className:r,variables:i}=Hv(l,n,o)
r&&t.push(r),i&&a.push(...i)})
const{cols:n}=jv(e.cols),{cols:o}=jv(e.offset)
...
return()=>t.h(e.tag,{class:[o.value.classes,e.class],style:[{"--v-col-size-base":l.value},{"--v-col-offset-base":n.value},o.value.variables,e.style]},a.default?.())}}),Gv=["start","end","center"],Kv=["space-between","space-around","space-evenly"],qv=[...Gv,"baseline","stretch"],Xv=e=>qv.includes(e),Zv=[...Gv,...Kv],Qv=e=>Zv.includes(e),Jv=[...Gv,...Kv,"stretch"],ep=e=>Jv.includes(e),tp={align:["align","alignSm","alignMd","alignLg","alignXl","alignXxl"],justify:["justify","justifySm","justifyMd","justifyLg","justifyXl","justifyXxl"],alignContent:["alignContent","alignContentSm","alignContentMd","alignContentLg","alignContentXl","alignContentXxl"]},ap={align:"align",justify:"justify",alignContent:"align-content"}
function lp(e,t,a){let l=ap[e]
if(null!=a){if(t){l+=`-${t.replace(e,"")}`}return l+=`-${a}`,l.toLowerCase()}}const np=rt({dense:Boolean,align:{type:String,default:null,validator:Xv},alignSm:{type:String,default:null,validator:Xv},alignMd:{type:String,default:null,validator:Xv},alignLg:{type:String,default:null,validator:Xv},alignXl:{type:String,default:null,validator:Xv},alignXxl:{type:String,default:null,validator:Xv},justify:{type:String,default:null,validator:Qv},justifySm:{type:String,default:null,validator:Qv},justifyMd:{type:String,default:null,validator:Qv},justifyLg:{type:String,default:null,validator:Qv},justifyXl:{type:String,default:null,validator:Qv},justifyXxl:{type:String,default:null,validator:Qv},alignContent:{type:String,default:null,validator:ep},alignContentSm:{type:String,default:null,validator:ep},alignContentMd:{type:String,default:null,validator:ep},alignContentLg:{type:String,default:null,validator:ep},alignContentXl:{type:String,default:null,validator:ep},alignContentXxl:{type:String,default:null,validator:ep},noGutters:Boolean,gap:[Number,String,Array],size:[Number,String],...it(),...Al(),...xa()},"VRow"),op=ft()({name:"VRow",props:np(),setup(e,{slots:a}){e.dense&&n("dense",'density="comfortable"')
const l=t.computed(()=>{const t=[]
let a
for(a in tp)tp[a].forEach(l=>{const n=e[l],o=lp(a,l,n)
o&&t.push(o)})
...
return{minDate:l,maxDate:n,clampDate:function(e){return l.value&&a.isBefore(e,l.value)?l.value:n.value&&a.isAfter(e,n.value)?n.value:e},isInAllowedRange:function(e){return(!l.value||a.isAfter(e,l.value))&&(!n.value||a.isBefore(e,n.value))}}}const pp=rt({color:String,hideWeekdays:Boolean,multiple:[Boolean,Number,String],showWeek:Boolean,readonly:Boolean,transition:{type:String,default:"picker-transition"},reverseTransition:{type:String,default:"picker-reverse-transition"},events:{type:[Array,Function,Object],default:()=>null},eventColor:{type:[Array,Function,Object,String],default:()=>null},...x(dp(),["displayValue"])},"VDatePickerMonth"),mp=ft()({name:"VDatePickerMonth",props:pp(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0},setup(e,{emit:a,slots:l}){const n=t.ref(),{t:o}=sa(),{daysInMonth:r,model:i,weekNumbers:s,weekdayLabels:u}=function(e){const a=Eu(),l=Zt(e,"modelValue",[],e=>P(e).map(e=>a.date(e))),n=t.computed(()=>e.displayValue?a.date(e.displayValue):l.value.length>0?a.date(l.value[0]):e.min?a.date(e.min):Array.isArray(e.allowedDates)?a.date(e.allowedDates[0]):a.date()),o=Zt(e,"year",void 0,e=>{const t=null!=e?Number(e):a.getYear(n.value)
...
return f.value&&!r&&(a.isDisabled=!0),t.createElementVNode("div",{class:t.normalizeClass(["v-date-picker-month__day",{"v-date-picker-month__day--adjacent":a.isAdjacent,"v-date-picker-month__day--hide-adjacent":a.isHidden,"v-date-picker-month__day--selected":r,"v-date-picker-month__day--week-end":a.isWeekEnd,"v-date-picker-month__day--week-start":a.isWeekStart}]),"data-v-date":a.isDisabled?void 0:a.isoDate},[(e.showAdjacentMonths||!a.isAdjacent)&&(l.day?.(o)??t.createVNode(Tn,o.props,{default:()=>[a.localized,y(a.isoDate)]}))])})])]})]))}}),fp=rt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,year:Number,allowedMonths:[Array,Function]},"VDatePickerMonths"),gp=ft()({name:"VDatePickerMonths",props:fp(),emits:{"update:modelValue":e=>!0},setup(e,{emit:a,slots:l}){const n=Eu(),o=Zt(e,"modelValue"),r=t.computed(()=>{let t=n.startOfYear(n.date())
...
o.value=e}(r)}
return l.month?.({month:n,i:r,props:i})??t.createVNode(Tn,t.mergeProps({key:"month"},i),null)})])])),{}}}),hp=rt({color:String,height:[String,Number],min:null,max:null,modelValue:Number,allowedYears:[Array,Function]},"VDatePickerYears"),yp=ft()({name:"VDatePickerYears",props:hp(),directives:{vIntersect:ml},emits:{"update:modelValue":e=>!0},setup(e,{emit:a,slots:l}){const n=Eu(),o=Zt(e,"modelValue"),r=t.shallowRef(!1),i=t.computed(()=>{const t=n.getYear(n.date())
let a=t-100,l=t+52
...
return l.year?.({year:n,i:r,props:i})??t.createVNode(Tn,t.mergeProps({key:"month"},i),null)})])]),[[ml,{handler:c},null,{once:!0}]])),{}}}),bp=rt({header:{type:String,default:"$vuetify.datePicker.header"},headerColor:String,headerDateFormat:{type:String,default:"normalDateWithWeekday"},landscapeHeaderWidth:[Number,String],...x(ip(),["active","monthText","yearText"]),...pp({weeksInMonth:"static"}),...x(fp(),["modelValue"]),...x(hp(),["modelValue"]),...id({title:"$vuetify.datePicker.title"}),modelValue:null},"VDatePicker"),Vp=ft()({name:"VDatePicker",props:bp(),emits:{"update:modelValue":e=>!0,"update:month":e=>!0,"update:year":e=>!0,"update:viewMode":e=>!0},setup(e,{emit:a,slots:l}){const n=Eu(),{t:o}=sa(),{rtlClasses:r}=ca(),i=Zt(e,"modelValue",void 0,e=>P(e).map(e=>n.date(e)),t=>e.multiple?t:t[0]),s=Zt(e,"viewMode"),{minDate:u,maxDate:c,clampDate:d}=vp(e),v=t.computed(()=>{const e=n.date(),t=i.value?.[0]?n.date(i.value[0]):d(e)
...
i!==g.value&&(g.value=i,O()),s!==y.value&&(y.value=s,j()),b.value=n.isBefore(o,r)}),It(()=>{const a=sd.filterProps(e),n=x(sp.filterProps(e),["viewMode"]),d=cp.filterProps(e),v=mp.filterProps(e),m=x(gp.filterProps(e),["modelValue"]),h=x(yp.filterProps(e),["modelValue"]),b={color:p.value,header:V.value,transition:C.value}
return t.createVNode(sd,t.mergeProps(a,{color:p.value,class:["v-date-picker",`v-date-picker--${s.value}`,{"v-date-picker--show-week":e.showWeek},r.value,e.class],style:[{"--v-date-picker-landscape-header-width":f(e.landscapeHeaderWidth)},e.style]}),{title:()=>l.title?.()??t.createElementVNode("div",{class:"v-date-picker__title"},[o(e.title)]),header:()=>l.header?t.createVNode(Ja,{defaults:{VDatePickerHeader:{...b}}},{default:()=>[l.header?.(b)]}):t.createVNode(cp,t.mergeProps({key:"header"},d,b,{onClick:"month"!==s.value?M:void 0}),{prepend:l.prepend,append:l.append}),default:()=>t.createElementVNode(t.Fragment,null,[t.createVNode(sp,t.mergeProps(n,{disabled:E.value,viewMode:s.value,text:S.value,monthText:k.value,yearText:N.value,"onClick:next":T,"onClick:prev":B,"onClick:nextYear":F,"onClick:prevYear":$,"onClick:month":z,"onClick:year":L}),{default:l.controls}),t.createVNode(za,{hideOnLeave:!0},{default:()=>["months"===s.value?t.createVNode(gp,t.mergeProps({key:"date-picker-months"},m,{modelValue:g.value,"onUpdate:modelValue":[e=>g.value=e,O],min:u.value,max:c.value,year:y.value,allowedMonths:_.value}),{month:l.month}):"year"===s.value?t.createVNode(yp,t.mergeProps({key:"date-picker-years"},h,{modelValue:y.value,"onUpdate:modelValue":[e=>y.value=e,j],min:u.value,max:c.value,allowedYears:I.value}),{year:l.year}):t.createVNode(mp,t.mergeProps({key:"date-picker-month"},v,{modelValue:i.value,"onUpdate:modelValue":e=>i.value=e,month:g.value,"onUpdate:month":[e=>g.value=e,O],year:y.value,"onUpdate:year":[e=>y.value=e,j],min:u.value,max:c.value}),{day:l.day})]})]),actions:l.actions})}),{}}}),wp=rt({actionText:String,bgColor:String,color:String,icon:_t,image:String,justify:{type:String,default:"center"},headline:String,title:String,text:String,textWidth:{type:[Number,String],default:500},href:String,to:String,...it(),...el(),...ql({size:void 0}),...va()},"VEmptyState"),Sp=ft()({name:"VEmptyState",props:wp(),emits:{"click:action":e=>!0},setup(e,{emit:a,slots:l}){const{themeClasses:n}=Va(e),{backgroundColorClasses:o,backgroundColorStyles:r}=rl(()=>e.bgColor),{dimensionStyles:i}=tl(e),{displayClasses:s}=Ro()
...
function Bp(e,t=""){return new Promise((a,l)=>{if(e.isFile){e.file(e=>a([{file:e,path:t}]),l)}else if(e.isDirectory){e.createReader().readEntries(async e=>{const l=[]
for(const a of e)l.push(...await Bp(a,Fp(t,a)))
a(l)})}})}function Fp(e,t){return t.isDirectory?`${e}/${t.name}`:e}const $p=rt({filterByType:String},"file-accept")
const Mp=rt({chips:Boolean,counter:Boolean,counterSizeString:{type:String,default:"$vuetify.fileInput.counterSize"},counterString:{type:String,default:"$vuetify.fileInput.counter"},hideInput:Boolean,multiple:Boolean,showSize:{type:[Boolean,Number,String],default:!1,validator:e=>"boolean"==typeof e||[1e3,1024].includes(Number(e))},truncateLength:{type:[Number,String],default:22},...x(go({prependIcon:"$file"}),["direction"]),modelValue:{type:[Array,Object],default:e=>e.multiple?[]:null,validator:e=>P(e).every(e=>null!=e&&"object"==typeof e)},...$p(),...Fi({clearable:!0})},"VFileInput"),zp=ft()({name:"VFileInput",inheritAttrs:!1,props:Mp(),emits:{"click:control":e=>!0,"mousedown:control":e=>!0,"update:focused":e=>!0,"update:modelValue":e=>!0,rejected:e=>!0},setup(e,{attrs:a,emit:l,slots:n}){const{t:o}=sa(),{filterAccepted:r}=function(e){const a=t.computed(()=>e.filterByType?function(e){const t=e.split(",").map(e=>e.trim().toLowerCase()),a=t.filter(e=>e.startsWith(".")),l=t.filter(e=>e.endsWith("/*")),n=t.filter(e=>!a.includes(e)&&!l.includes(e))
...
if(a.length)for(const e of a){const a=await Bp(e,Fp(".",e))
...
function Up(e,t,a){const l=a&&e.mac?e.mac:e.default,n="icon"===t&&!l.icon||"symbol"===t&&!l.symbol?"text":t
let o=l[n]??l.text
return"text"===n&&"string"==typeof o&&o.startsWith("$")&&!o.startsWith("$vuetify.")&&(o=o.slice(1).toUpperCase()),"icon"===n?["icon",o]:[n,o]}const Gp={ctrl:{mac:{symbol:"⌃",icon:"$ctrl",text:"$vuetify.hotkey.ctrl"},default:{text:"Ctrl"}},meta:{mac:{symbol:"⌘",icon:"$command",text:"$vuetify.hotkey.command"},default:{text:"Ctrl"}},cmd:{mac:{symbol:"⌘",icon:"$command",text:"$vuetify.hotkey.command"},default:{text:"Ctrl"}},shift:{mac:{symbol:"⇧",icon:"$shift",text:"$vuetify.hotkey.shift"},default:{text:"Shift"}},alt:{mac:{symbol:"⌥",icon:"$alt",text:"$vuetify.hotkey.option"},default:{text:"Alt"}},enter:{default:{symbol:"↵",icon:"$enter",text:"$vuetify.hotkey.enter"}},arrowup:{default:{symbol:"↑",icon:"$arrowup",text:"$vuetify.hotkey.upArrow"}},arrowdown:{default:{symbol:"↓",icon:"$arrowdown",text:"$vuetify.hotkey.downArrow"}},arrowleft:{default:{symbol:"←",icon:"$arrowleft",text:"$vuetify.hotkey.leftArrow"}},arrowright:{default:{symbol:"→",icon:"$arrowright",text:"$vuetify.hotkey.rightArrow"}},backspace:{default:{symbol:"⌫",icon:"$backspace",text:"$vuetify.hotkey.backspace"}},escape:{default:{text:"$vuetify.hotkey.escape"}}," ":{mac:{symbol:"␣",icon:"$space",text:"$vuetify.hotkey.space"},default:{text:"$vuetify.hotkey.space"}},"-":{default:{text:"-"}},"+":{default:{text:"+"}}},Kp=rt({keys:String,displayMode:{type:String,default:"icon"},keyMap:{type:Object,default:()=>Gp},platform:{type:String,default:"auto"},inline:Boolean,disabled:Boolean,prefix:String,suffix:String,variant:{type:String,default:"elevated",validator:e=>["elevated","flat","tonal","outlined","text","plain","contained"].includes(e)},...it(),...va(),...hl(),...sl(),...bl(),color:String},"VHotkey"),qp=Symbol("VHotkey:AND_DELINEATOR"),Xp=Symbol("VHotkey:SLASH_DELINEATOR"),Zp=Symbol("VHotkey:THEN_DELINEATOR")
function Qp(e,t,a,l){const n=a.toLowerCase()
if(n in e){const o=Up(e[n],t,l)
return"text"===o[0]&&"string"==typeof o[1]&&o[1].startsWith("$")&&!o[1].startsWith("$vuetify.")?["text",o[1].replace("$","").toUpperCase(),a]:[...o,a]}return["text",a.toUpperCase(),a]}const Jp=ft()({name:"VHotkey",props:Kp(),setup(e){const{t:a}=sa(),{themeClasses:l}=Va(e),{rtlClasses:n}=ca(),{borderClasses:o}=yl(e),{roundedClasses:r}=ul(e),{elevationClasses:i}=Vl(e),{colorClasses:s,colorStyles:u,variantClasses:c}=$l(()=>({color:e.color,variant:"contained"===e.variant?"elevated":e.variant})),d=t.computed(()=>"auto"===e.platform?"undefined"!=typeof navigator&&/macintosh/i.test(navigator.userAgent):"mac"===e.platform),v=t.computed(()=>e.keys?e.keys.split(" ").map(t=>{const a=[],l=zu(t)
for(let t=0;t<l.length;t++){const n=l[t]
t>0&&a.push(Zp)
const{keys:o,separators:r}=Mu(n)
for(let t=0;t<o.length;t++){const l=o[t]
t>0&&a.push("/"===r[t-1]?Xp:qp),a.push(Qp(e.keyMap,e.displayMode,l,d.value))}}return a}):[]),p=t.computed(()=>{if(!e.keys)return""
const t=v.value.map(t=>{const l=[]
for(const n of t)if(Array.isArray(n)){const t="icon"===n[0]||"symbol"===n[0]?Qp($(Gp,e.keyMap),"text",String(n[1]),d.value)[1]:n[1]
l.push(m(t))}else n===qp?l.push(a("$vuetify.hotkey.plus")):n===Xp?l.push(a("$vuetify.hotkey.or")):n===Zp&&l.push(a("$vuetify.hotkey.then"))
return l.join(" ")}).join(", ")
...
if(l in e){const t=Up(e[l],"text",a)
return"string"==typeof t[1]?t[1]:String(t[1])}return t.toUpperCase()}(e.keyMap,String(t[2]),d.value)
return m(a)}It(()=>{const d=t.createElementVNode(t.Fragment,null,[e.prefix&&t.createElementVNode("span",{key:"prefix",class:"v-hotkey__prefix"},[e.prefix]),v.value.map((l,n)=>t.createElementVNode("span",{class:"v-hotkey__combination",key:n},[l.map((l,n)=>Array.isArray(l)?function(a,l){const n="contained"===e.variant,c=n?"kbd":Yp,d=["v-hotkey__key",`v-hotkey__key-${a[0]}`,...n?["v-hotkey__key--nested"]:[o.value,r.value,i.value,s.value]]
return t.createVNode(c,{key:l,class:t.normalizeClass(d),style:t.normalizeStyle(n?void 0:u.value),"aria-hidden":"true",title:f(a)},{default:()=>["icon"===a[0]?t.createVNode(Ql,{icon:a[1],"aria-hidden":"true"},null):m(a[1])]})}(l,n):function(e,l){return t.createElementVNode("span",{key:l,class:"v-hotkey__divider","aria-hidden":"true"},[e===qp?"+":e===Xp?"/":a("$vuetify.hotkey.then")])}(l,n)),n<v.value.length-1&&t.createElementVNode("span",{"aria-hidden":"true"},[t.createTextVNode(" ")])])),e.suffix&&t.createElementVNode("span",{key:"suffix",class:"v-hotkey__suffix"},[e.suffix])])
return t.createElementVNode("div",{class:t.normalizeClass(["v-hotkey",{"v-hotkey--disabled":e.disabled,"v-hotkey--inline":e.inline,"v-hotkey--contained":"contained"===e.variant},l.value,n.value,c.value,e.class]),style:t.normalizeStyle(e.style),role:"img","aria-label":p.value},["contained"!==e.variant?d:t.createVNode(Yp,{key:"contained",class:t.normalizeClass(["v-hotkey__contained-wrapper",o.value,r.value,i.value,s.value]),style:t.normalizeStyle(u.value),"aria-hidden":"true"},{default:()=>[d]})])})}}),em=rt({disabled:Boolean,modelValue:{type:Boolean,default:null},...li()},"VHover"),tm=ft()({name:"VHover",props:em(),emits:{"update:modelValue":e=>!0},setup(e,{slots:t}){const a=Zt(e,"modelValue"),{runOpenDelay:l,runCloseDelay:n}=ni(e,t=>!e.disabled&&(a.value=t))
return()=>t.default?.({isHovering:a.value,props:{onMouseenter:l,onMouseleave:n}})}}),am=rt({color:String,direction:{type:String,default:"vertical",validator:e=>["vertical","horizontal"].includes(e)},side:{type:String,default:"end",validator:e=>["start","end","both"].includes(e)},mode:{type:String,default:"intersect",validator:e=>["intersect","manual"].includes(e)},margin:[Number,String],loadMoreText:{type:String,default:"$vuetify.infiniteScroll.loadMore"},emptyText:{type:String,default:"$vuetify.infiniteScroll.empty"},...el(),...xa()},"VInfiniteScroll"),lm=mt({name:"VInfiniteScrollIntersect",props:{side:{type:String,required:!0},rootMargin:String},emits:{intersect:(e,t)=>!0},setup(e,{emit:a}){const{intersectionRef:l,isIntersecting:n}=Jl()
return t.watch(n,async t=>{a("intersect",e.side,t)}),It(()=>t.createElementVNode("div",{class:"v-infinite-scroll-intersect",style:{"--v-infinite-margin-size":e.rootMargin},ref:l},[t.createTextVNode(" ")])),{}}}),nm=ft()({name:"VInfiniteScroll",props:am(),emits:{load:e=>!0},setup(e,{slots:a,emit:l}){const n=t.ref(),o=t.shallowRef("ok"),r=t.shallowRef("ok"),i=t.computed(()=>f(e.margin)),s=t.shallowRef(!1)
...
return t.createVNode(l,{ref:n,class:t.normalizeClass(["v-infinite-scroll",`v-infinite-scroll--${e.direction}`,{"v-infinite-scroll--start":s,"v-infinite-scroll--end":u}]),style:t.normalizeStyle(b.value)},{default:()=>[t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("start",o.value)]),s&&c&&t.createVNode(lm,{key:"start",side:"start",onIntersect:m,rootMargin:i.value},null),a.default?.(),u&&c&&t.createVNode(lm,{key:"end",side:"end",onIntersect:m,rootMargin:i.value},null),t.createElementVNode("div",{class:"v-infinite-scroll__side"},[y("end",r.value)])]})}),{reset:function(a){const l=a??e.side
v(l,"ok"),t.nextTick(()=>{"end"!==l&&u(d()-p+c()),"manual"!==e.mode&&t.nextTick(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{window.requestAnimationFrame(()=>{"both"===l?(g("start"),g("end")):g(l)})})})})})}}}}),om=Symbol.for("vuetify:v-item-group"),rm=rt({...it(),...Ll({selectedClass:"v-item--selected"}),...xa(),...va()},"VItemGroup"),im=ft()({name:"VItemGroup",props:rm(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{themeClasses:l}=Va(e),{isSelected:n,select:o,next:r,prev:i,selected:s}=Hl(e,om)
return()=>t.createVNode(e.tag,{class:t.normalizeClass(["v-item-group",l.value,e.class]),style:t.normalizeStyle(e.style)},{default:()=>[a.default?.({isSelected:n,select:o,next:r,prev:i,selected:s.value})]})}}),sm=ft()({name:"VItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,{slots:t}){const{isSelected:a,select:l,toggle:n,selectedClass:o,value:r,disabled:i}=jl(e,om)
return()=>t.default?.({isSelected:a.value,selectedClass:o.value,select:l,toggle:n,value:r.value,disabled:i.value})}}),um=rt({...it(),...el(),...Yt()},"VLayout"),cm=ft()({name:"VLayout",props:um(),setup(e,{slots:a}){const{layoutClasses:l,layoutStyles:n,getLayoutItem:o,items:r,layoutRef:i}=qt(e),{dimensionStyles:s}=tl(e)
return It(()=>t.createElementVNode("div",{ref:i,class:t.normalizeClass([l.value,e.class]),style:t.normalizeStyle([s.value,n.value,e.style])},[a.default?.()])),{getLayoutItem:o,items:r}}}),dm=rt({position:{type:String,required:!0},size:{type:[Number,String],default:300},modelValue:Boolean,...it(),...Ut()},"VLayoutItem"),vm=ft()({name:"VLayoutItem",props:dm(),setup(e,{slots:a}){const{layoutItemStyles:l}=Kt({id:e.name,order:t.computed(()=>parseInt(e.order,10)),position:t.toRef(()=>e.position),elementSize:t.toRef(()=>e.size),layoutSize:t.toRef(()=>e.size),active:t.toRef(()=>e.modelValue),absolute:t.toRef(()=>e.absolute)})
return()=>t.createElementVNode("div",{class:t.normalizeClass(["v-layout-item",e.class]),style:t.normalizeStyle([l.value,e.style])},[a.default?.()])}}),pm=rt({modelValue:Boolean,options:{type:Object,default:()=>({root:void 0,rootMargin:void 0,threshold:void 0})},...it(),...el(),...xa(),...cl({transition:"fade-transition"})},"VLazy"),mm=ft()({name:"VLazy",directives:{vIntersect:ml},props:pm(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{dimensionStyles:l}=tl(e),n=Zt(e,"modelValue")
function o(e){n.value||(n.value=e)}return It(()=>t.withDirectives(t.createVNode(e.tag,{class:t.normalizeClass(["v-lazy",e.class]),style:t.normalizeStyle([l.value,e.style])},{default:()=>[n.value&&t.createVNode(dl,{transition:e.transition,appear:!0},{default:()=>[a.default?.()]})]}),[[ml,{handler:o,options:e.options},null]])),{}}}),fm=rt({locale:String,fallbackLocale:String,messages:Object,rtl:{type:Boolean,default:void 0},...it()},"VLocaleProvider"),gm=ft()({name:"VLocaleProvider",props:fm(),setup(e,{slots:a}){const{rtlClasses:l}=ua(e)
return It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-locale-provider",l.value,e.class]),style:t.normalizeStyle(e.style)},[a.default?.()])),{}}}),hm=rt({scrollable:Boolean,...it(),...el(),...xa({tag:"main"})},"VMain"),ym=ft()({name:"VMain",props:hm(),setup(e,{slots:a}){const{dimensionStyles:l}=tl(e),{mainStyles:n}=Gt(),{ssrBootStyles:o}=Il()
...
function bm(e){return(e<0?-1:1)*Math.sqrt(Math.abs(e))*1.41421356237}function Vm(e){if(e.length<2)return 0
if(2===e.length)return e[1].t===e[0].t?0:(e[1].d-e[0].d)/(e[1].t-e[0].t)
let t=0
for(let a=e.length-1;a>0;a--){if(e[a].t===e[a-1].t)continue
const l=bm(t),n=(e[a].d-e[a-1].d)/(e[a].t-e[a-1].t)
t+=(n-l)*Math.abs(n),a===e.length-1&&(t*=.5)}return 1e3*bm(t)}function wm(){const e={}
...
n.push({t:e[0],d:e[1].clientX}),o.push({t:e[0],d:e[1].clientY})}return{x:Vm(n),y:Vm(o),get direction(){const{x:e,y:t}=this,[a,l]=[Math.abs(e),Math.abs(t)]
return a>l&&e>=0?"right":a>l&&e<=0?"left":l>a&&t>=0?"down":l>a&&t<=0?"up":function(){throw new Error}()}}}}}function Sm(){throw new Error}const km=["start","end","left","right","top","bottom"],xm=rt({color:String,disableResizeWatcher:Boolean,disableRouteWatcher:Boolean,expandOnHover:Boolean,floating:Boolean,modelValue:{type:Boolean,default:null},permanent:Boolean,rail:{type:Boolean,default:null},railWidth:{type:[Number,String],default:56},scrim:{type:[Boolean,String],default:!0},image:String,temporary:Boolean,persistent:Boolean,touchless:Boolean,width:{type:[Number,String],default:256},location:{type:String,default:"start",validator:e=>km.includes(e)},sticky:Boolean,...hl(),...it(),...li(),...Po({mobile:null}),...bl(),...Ut(),...sl(),...x(si(),["disableInitialFocus"]),...xa({tag:"nav"}),...va()},"VNavigationDrawer"),Nm=ft()({name:"VNavigationDrawer",props:xm(),emits:{"update:modelValue":e=>!0,"update:rail":e=>!0},setup(e,{attrs:a,emit:l,slots:n}){const{isRtl:o}=ca(),{themeClasses:r}=Va(e),{borderClasses:i}=yl(e),{backgroundColorClasses:s,backgroundColorStyles:u}=rl(()=>e.color),{elevationClasses:c}=Vl(e),{displayClasses:d,mobile:v}=Ro(e),{roundedClasses:p}=ul(e),m=pn(),g=Zt(e,"modelValue",null,e=>!!e),{ssrBootStyles:h}=Il(),{scopeId:y}=gi(),b=t.ref(),V=t.shallowRef(!1),{runOpenDelay:w,runCloseDelay:S}=ni(e,e=>{V.value=e}),k=t.computed(()=>e.rail&&e.expandOnHover&&V.value?Number(e.width):Number(e.rail?e.railWidth:e.width)),x=t.computed(()=>ce(e.location,o.value)),N=t.toRef(()=>e.persistent),C=t.computed(()=>!e.permanent&&(v.value||e.temporary)),E=t.computed(()=>e.sticky&&!C.value&&"bottom"!==x.value)
...
const i=t.computed(()=>["left","right"].includes(r.value)),{addMovement:s,endTouch:u,getVelocity:c}=wm()
let d=!1
...
null!=e.precision&&(a=Math.max(a,e.precision)),t?h.value&&(f.value=d(v.value+e.step,a)):y.value&&(f.value=d(v.value-e.step,a))}function I(a){if(i.value)return
if(!a.data)return
const l=a.target,{value:n,selectionStart:o,selectionEnd:r}=l??{},s=n?n.slice(0,o)+a.data+n.slice(r):a.data,u=function(e,t,a){const l=new RegExp(`[\\d\\-${oe(a)}]`),n=e.split("").filter(e=>l.test(e)).filter((e,t,l)=>0===t&&/[-]/.test(e)||e===a&&t===l.indexOf(e)||/\d/.test(e)).join("")
if(0===t)return n.split(a)[0]
const o=new RegExp(`${oe(a)}\\d`)
if(null!==t&&o.test(n)){const e=n.split(a)
return[e[0],e[1].substring(0,t)].join(a)}return n}(s,e.precision,c.value)
if(new RegExp(`^-?\\d*${oe(c.value)}?\\d*$`).test(s)||(a.preventDefault(),l.value=u,t.nextTick(()=>f.value=u)),null!=e.precision){if(s.split(c.value)[1]?.length>e.precision){a.preventDefault(),l.value=u,t.nextTick(()=>f.value=u)
const e=(o??0)+a.data.length
l.setSelectionRange(e,e)}0===e.precision&&s.endsWith(c.value)&&(a.preventDefault(),l.value=u,t.nextTick(()=>f.value=u))}}async function _(e){["Enter","ArrowLeft","ArrowRight","Backspace","Delete","Tab"].includes(e.key)||e.ctrlKey||["ArrowDown","ArrowUp"].includes(e.key)&&(e.preventDefault(),e.stopPropagation(),B(),await t.nextTick(),"ArrowDown"===e.key?E(!1):E())}function P(e){e.stopPropagation()}function R(e){const t=e.currentTarget
...
const Rm=rt({scale:{type:[Number,String],default:.5},...it()},"VParallax"),Am=ft()({name:"VParallax",props:Rm(),setup(e,{slots:a}){const{intersectionRef:l,isIntersecting:n}=Jl(),{resizeRef:o,contentRect:r}=jt(),{height:i}=Ro(),s=t.ref()
let u
...
const a=Yc(t,o.value.$el,e.direction),l=Yc(t,r.value.$el,e.direction),n=Math.abs(a),i=Math.abs(l)
...
return t.createVNode(e.tag,{class:t.normalizeClass(["v-rating",{"v-rating--hover":e.hover,"v-rating--readonly":e.readonly},n.value,e.class]),style:t.normalizeStyle(e.style),ref:o},{default:()=>[t.createVNode(b,{value:0,index:-1,showStar:!1},null),s.value.map((a,n)=>t.createElementVNode("div",{class:"v-rating__wrapper"},[l&&"top"===e.itemLabelPosition?V({value:a,index:n,label:e.itemLabels?.[n]}):void 0,t.createElementVNode("div",{class:"v-rating__item"},[e.halfIncrements?t.createElementVNode(t.Fragment,null,[t.createVNode(b,{value:a-.5,index:2*n},null),t.createVNode(b,{value:a,index:2*n+1},null)]):t.createVNode(b,{value:a,index:n},null)]),l&&"bottom"===e.itemLabelPosition?V({value:a,index:n,label:e.itemLabels?.[n]}):void 0]))]})}),{}}}),Om={actions:"button@2",article:"heading, paragraph",avatar:"avatar",button:"button",card:"image, heading","card-avatar":"image, list-item-avatar",chip:"chip","date-picker":"list-item, heading, divider, date-picker-options, date-picker-days, actions","date-picker-options":"text, avatar@2","date-picker-days":"avatar@28",divider:"divider",heading:"heading",image:"image","list-item":"text","list-item-avatar":"avatar, text","list-item-two-line":"sentences","list-item-avatar-two-line":"avatar, sentences","list-item-three-line":"paragraph","list-item-avatar-three-line":"avatar, paragraph",ossein:"ossein",paragraph:"text@3",sentences:"text@2",subtitle:"text",table:"table-heading, table-thead, table-tbody, table-tfoot","table-heading":"chip, text","table-thead":"heading@6","table-tbody":"table-row-divider@6","table-row-divider":"table-row, divider","table-row":"text@6","table-tfoot":"text@2, avatar@2",text:"text"}
function jm(e,a=[]){return t.createElementVNode("div",{class:t.normalizeClass(["v-skeleton-loader__bone",`v-skeleton-loader__${e}`])},[a])}function Hm(e){const[t,a]=e.split("@")
return Array.from({length:a}).map(()=>Wm(t))}function Wm(e){let t=[]
if(!e)return t
const a=Om[e]
if(e===a);else{if(e.includes(","))return Ym(e)
if(e.includes("@"))return Hm(e)
a.includes(",")?t=Ym(a):a.includes("@")?t=Hm(a):a&&t.push(Wm(a))}return[jm(e,t)]}function Ym(e){return e.replace(/\s/g,"").split(",").map(Wm)}const Um=rt({boilerplate:Boolean,color:String,loading:Boolean,loadingText:{type:String,default:"$vuetify.loading"},type:{type:[String,Array],default:"ossein"},...el(),...bl(),...va()},"VSkeletonLoader"),Gm=ft()({name:"VSkeletonLoader",inheritAttrs:!1,props:Um(),setup(e,{attrs:a,slots:l}){const{backgroundColorClasses:n,backgroundColorStyles:o}=rl(()=>e.color),{dimensionStyles:r}=tl(e),{elevationClasses:i}=Vl(e),{themeClasses:s}=Va(e),{t:u}=sa(),c=t.computed(()=>Wm(P(e.type).join(",")))
return It(()=>{const d=!l.default||e.loading,v=e.boilerplate||!d?{}:{ariaLive:"polite",ariaLabel:u(e.loadingText),role:"alert"}
return d?t.createElementVNode("div",t.mergeProps({class:["v-skeleton-loader",{"v-skeleton-loader--boilerplate":e.boilerplate},s.value,n.value,i.value],style:[o.value,r.value]},v,a),[c.value]):t.createElementVNode(t.Fragment,null,[l.default?.()])}),{}}}),Km=ft()({name:"VSlideGroupItem",props:Ol(),emits:{"group:selected":e=>!0},setup(e,{slots:t}){const a=jl(e,Oo)
return()=>t.default?.({isSelected:a.isSelected.value,select:a.select,toggle:a.toggle,selectedClass:a.selectedClass.value})}}),qm=Symbol.for("vuetify:v-snackbar-queue")
const Xm=rt({collapsed:Object,loading:Boolean,prependAvatar:String,prependIcon:_t,queueGap:Number,queueIndex:Number,title:String,text:String,reverseTimer:Boolean,timer:{type:[Boolean,String],default:!1},timerColor:String,timeout:{type:[Number,String],default:5e3},vertical:Boolean,...Sl({location:"bottom"}),...dn(),...sl(),...Fl(),...va(),...x(Ni({transition:"v-snackbar-transition"}),["persistent","noClickAnimation","offset","retainFocus","captureFocus","disableInitialFocus","scrim","scrollStrategy","stickToTarget","viewportMargin"])},"VSnackbar"),Zm=ft()({name:"VSnackbar",props:Xm(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=Zt(e,"modelValue"),{positionClasses:n}=vn(e),{scopeId:o}=gi(),{themeClasses:r}=Va(e),{colorClasses:i,colorStyles:s,variantClasses:u}=$l(e),{roundedClasses:c}=ul(e),d=function(e){const a=t.shallowRef(e())
let l=-1
...
a.value=Math.max(e()-t,0),a.value<=0&&n()},r)},reset:function(){n(),t.nextTick(()=>a.value=e())}}}(()=>Number(e.timeout)),v=t.ref(),p=function(e,a){const l=t.inject(qm,null)
if(!l)return null
const n=t.useId()
...
const Qm=rt({closable:[Boolean,String],closeText:{type:String,default:"$vuetify.dismiss"},collapsed:Boolean,displayStrategy:{type:String,default:"hold"},modelValue:{type:Array,default:()=>[]},totalVisible:{type:[Number,String],default:1},gap:{type:[Number,String],default:8},...x(Xm(),["modelValue","collapsed","queueIndex","queueGap"])},"VSnackbarQueue"),Jm=ft()({name:"VSnackbarQueue",inheritAttrs:!1,props:Qm(),emits:{"update:modelValue":e=>!0},setup(e,{attrs:a,emit:l,slots:n}){const{t:r}=sa(),i=function(){const e=t.shallowRef(o?document.visibilityState:"visible")
...
return t.provide(qm,o),o}(e),u=t.shallowRef(!1),{runOpenDelay:c,runCloseDelay:d}=ni({openDelay:0,closeDelay:500},e=>{u.value=e,y()})
let v=0
...
return t.withDirectives(t.createElementVNode("button",{class:t.normalizeClass(["v-stepper-item",{"v-stepper-item--complete":u.value,"v-stepper-item--disabled":e.disabled,"v-stepper-item--error":s.value},l?.selectedClass.value]),disabled:!e.editable,type:"button",onClick:function(){l?.toggle()}},[r.value&&Bl(!0,"v-stepper-item"),t.createVNode(Gn,{key:"stepper-avatar",class:"v-stepper-item__avatar",color:o?e.color:void 0,size:24},{default:()=>[a.icon?.(d.value)??(c.value?t.createVNode(Ql,{icon:c.value},null):n.value)]}),t.createElementVNode("div",{class:"v-stepper-item__content"},[v&&t.createElementVNode("div",{key:"title",class:"v-stepper-item__title"},[a.title?.(d.value)??e.title]),p&&t.createElementVNode("div",{key:"subtitle",class:"v-stepper-item__subtitle"},[a.subtitle?.(d.value)??e.subtitle]),a.default?.(d.value)])]),[[An,e.editable&&e.ripple,null]])}),{}}}),wf=rt({...x(Ec(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VStepperWindow"),Sf=ft()({name:"VStepperWindow",props:wf(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=t.inject(mf,null),n=Zt(e,"modelValue"),o=t.computed({get:()=>null==n.value&&l?l.items.value.find(e=>l.selected.value.includes(e.id))?.value:n.value,set(e){n.value=e}})
return It(()=>{const l=Ic.filterProps(e)
return t.createVNode(Ic,t.mergeProps({_as:"VStepperWindow"},l,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-stepper-window",e.class],style:e.style,mandatory:!1,touch:!1}),a)}),{}}}),kf=rt({...Rc()},"VStepperWindowItem"),xf=ft()({name:"VStepperWindowItem",props:kf(),setup:(e,{slots:a})=>(It(()=>{const l=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({_as:"VStepperWindowItem"},l,{class:["v-stepper-window-item",e.class],style:e.style}),a)}),{})}),Nf=rt({altLabels:Boolean,bgColor:String,completeIcon:_t,editIcon:_t,editable:Boolean,errorIcon:_t,hideActions:Boolean,items:{type:Array,default:()=>[]},itemTitle:{type:[String,Array,Function],default:"title"},itemValue:{type:[String,Array,Function],default:"value"},itemProps:{type:[Boolean,String,Array,Function],default:"props"},nonLinear:Boolean,flat:Boolean,...Po()},"Stepper"),Cf=rt({...Nf(),...Ll({mandatory:"force",selectedClass:"v-stepper-item--selected"}),..._i(),...S(ff(),["prevText","nextText"])},"VStepper"),Ef=ft()({name:"VStepper",props:Cf(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const{items:l,next:n,prev:o,selected:r}=Hl(e,mf),{displayClasses:i,mobile:s}=Ro(e),{completeIcon:u,editIcon:c,errorIcon:d,color:v,editable:m,prevText:f,nextText:g}=t.toRefs(e),h=t.computed(()=>e.items.map((t,a)=>{const l={title:p(t,e.itemTitle,t),value:p(t,e.itemValue,a+1),...!0===e.itemProps?t:p(t,e.itemProps)}
...
return t.createVNode(Tn,t.mergeProps({symbol:Af,ref:s,class:["v-tab",e.class,d.value&&e.inset?r.value:[]],style:[e.style,d.value&&e.inset?i.value:[],{backgroundColor:d.value&&e.inset?"transparent !important":void 0}],tabindex:d.value?0:-1,role:"tab","aria-selected":String(d.value),active:!1},c,l,{block:e.fixed,maxWidth:e.fixed?300:void 0,"onGroup:selected":f}),{...a,default:()=>t.createElementVNode(t.Fragment,null,[a.default?.()??e.text,!e.hideSlider&&t.createElementVNode("div",{ref:u,class:t.normalizeClass(["v-tab__slider",e.inset?r.value:n.value]),style:t.normalizeStyle([o.value,e.inset?i.value:n.value])},null)])})}),Vo({},s)}}),Bf=rt({...x(Ec(),["continuous","nextIcon","prevIcon","showArrows","touch","mandatory"])},"VTabsWindow"),Ff=ft()({name:"VTabsWindow",props:Bf(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=t.inject(Af,null),n=Zt(e,"modelValue"),o=t.computed({get:()=>null==n.value&&l?l.items.value.find(e=>l.selected.value.includes(e.id))?.value:n.value,set(e){n.value=e}})
return It(()=>{const l=Ic.filterProps(e)
return t.createVNode(Ic,t.mergeProps({_as:"VTabsWindow"},l,{modelValue:o.value,"onUpdate:modelValue":e=>o.value=e,class:["v-tabs-window",e.class],style:e.style,mandatory:!1,touch:!1}),a)}),{}}}),$f=rt({...Rc()},"VTabsWindowItem"),Mf=ft()({name:"VTabsWindowItem",props:$f(),setup:(e,{slots:a})=>(It(()=>{const l=Ac.filterProps(e)
return t.createVNode(Ac,t.mergeProps({_as:"VTabsWindowItem"},l,{class:["v-tabs-window-item",e.class],style:e.style}),a)}),{})})
const zf=rt({alignTabs:{type:String,default:"start"},color:String,fixedTabs:Boolean,items:{type:Array,default:()=>[]},stacked:Boolean,bgColor:String,grow:Boolean,height:{type:[Number,String],default:void 0},hideSlider:Boolean,inset:Boolean,insetPadding:[String,Number],insetRadius:[String,Number],sliderColor:String,...S(Df(),["spaced","sliderTransition","sliderTransitionDuration"]),...jo({mandatory:"force",selectedClass:"v-tab-item--selected"}),...Al(),...xa()},"VTabs"),Lf=ft()({name:"VTabs",props:zf(),emits:{"update:modelValue":e=>!0},setup(e,{attrs:a,slots:l}){const n=Zt(e,"modelValue"),o=t.computed(()=>function(e){return e?e.map(e=>g(e)?e:{text:e,value:e}):[]}(e.items)),{densityClasses:r}=Dl(e),{backgroundColorClasses:i,backgroundColorStyles:s}=rl(()=>e.bgColor),{scopeId:u}=gi()
...
return t.createElementVNode("div",{class:t.normalizeClass([{"v-time-picker-clock__item":!0,"v-time-picker-clock__item--active":l,"v-time-picker-clock__item--disabled":e.disabled||!S(a)},l&&v.value]),style:t.normalizeStyle([E(a),l&&p.value])},[t.createElementVNode("span",null,[e.format(a)])])})])]))}}),Jf=rt({active:Boolean,color:String,disabled:Boolean,label:String,modelValue:String,error:String,showHint:Boolean,readonly:Boolean},"VTimePickerField"),eg=ft()({name:"VTimePickerField",props:Jf(),emits:{"update:modelValue":e=>!0},setup(e,{emit:a}){const{textColorClasses:l,textColorStyles:n}=ol(()=>e.color),o=t.ref(),r=t.shallowRef(!1)
...
return t.length>0?Number(t):null}const og=rt({allowedHours:[Function,Array],allowedMinutes:[Function,Array],allowedSeconds:[Function,Array],max:String,min:String},"time-validation")
function rg(e){const a=t.computed(()=>{const t=e.min?Number(e.min.split(":")[0]):0,a=e.max?Number(e.max.split(":")[0]):23
...
for(let e=1;e<=c&&!s(t=u(t));e++);return t}}}const ig=rt({ampm:Boolean,color:String,disabled:Boolean,inputHints:Boolean,hour:[Number,String],minute:[Number,String],second:[Number,String],period:String,readonly:Boolean,useSeconds:Boolean,value:Number,viewMode:String,...og()},"VTimePickerControls"),sg=ft()({name:"VTimePickerControls",props:ig(),emits:{"update:period":e=>!0,"update:viewMode":e=>!0,"update:hour":e=>!0,"update:minute":e=>!0,"update:second":e=>!0},setup(e,{emit:a}){const{t:l}=sa(),{isAllowedHour:n,isAllowedMinute:o,isAllowedSecond:r,findNextAllowed:i}=rg(e),s=t.computed(()=>null!==e.hour?e.ampm?lg(Number(e.hour),e.period??"am"):Number(e.hour):null),u=t.computed(()=>null!==e.minute?Number(e.minute):null),c=t.computed(()=>null===e.hour||(n.value?.(Number(s.value))??!0)),d=t.computed(()=>null===e.minute||(o.value?.(s.value,Number(e.minute))??!0)),v=t.computed(()=>null===e.second||(r.value?.(s.value,u.value,Number(e.second))??!0)),p=t=>{if(null==t||isNaN(Number(t)))return null
const a=Number(t)
return e.ampm?tg(ag(a)):tg(a)},m=t=>{if(isNaN(Number(t))||null==t||""===t)return null
const a="string"==typeof t?ng(t):Number(t)
return null===a?null:e.ampm?lg(a,e.period??"am"):A(a,0,23)},f=Zt(e,"hour",void 0,p,m),g=e=>null==e||isNaN(Number(e))?null:tg(`${e}`),h=e=>{if(isNaN(Number(e))||null==e||""===e)return null
...
const n="am"===e.period,o=e.ampm?lg(Number(f.value??0),n?"am":"pm"):Number(f.value??0),r=i("hour",o,"ArrowUp"===l.key),s=n&&r>=12||!n&&r<12
e.ampm&&s?(a("update:period","am"===e.period?"pm":"am"),t.nextTick(()=>f.value=tg(r))):f.value=tg(r)}function w(e){if(!["ArrowUp","ArrowDown"].includes(e.key))return
e.preventDefault(),e.stopPropagation()
const t=Number(y.value??0),a=i("minute",t,"ArrowUp"===e.key,s.value)
y.value=tg(a)}function S(e){if(!["ArrowUp","ArrowDown"].includes(e.key))return
e.preventDefault(),e.stopPropagation()
const t=Number(b.value??0),a=i("second",t,"ArrowUp"===e.key,s.value,u.value)
b.value=tg(a)}function k(t,a,l){return n=>{if(!n.data)return
...
r.value=n?lg(parseInt(t,10),n):parseInt(t,10),i.value=parseInt(a,10),s.value=parseInt(l||0,10)}v.value=null==r.value||r.value<12?"am":"pm"}function N(e){"hour"===p.value?r.value=g.value?lg(e,v.value):e:"minute"===p.value?i.value=e:s.value=e}function C(t){switch(p.value||"hour"){case"hour":a("update:hour",t)
break
...
null!==S()&&(u.value=r.value,c.value=i.value,e.useSeconds&&(d.value=s.value),l&&w())}t.watch(r,w),t.watch(i,w),t.watch(s,w),t.watch(v,(e,t)=>{null!=r.value&&e!==t&&("pm"===e&&r.value<12?r.value=r.value+12:"am"===e&&r.value>=12&&(r.value=r.value-12))}),t.watch(()=>e.modelValue,e=>k(e)),t.watch(()=>e.useSeconds,(e,t)=>{t&&!e&&"second"===p.value&&(p.value="minute"),e||null===s.value||(s.value=null)}),t.onMounted(()=>{k(e.modelValue)}),It(()=>{const a=x(sd.filterProps(e),["hideHeader"]),u=sg.filterProps(e),c=Qf.filterProps(x(e,["format","modelValue","min","max"])),d="hour"===p.value?h.value:"minute"===p.value?e=>y.value(r.value,e):e=>b.value(r.value,i.value,e)
return t.createVNode(sd,t.mergeProps(a,{color:void 0,class:["v-time-picker",`v-time-picker--variant-${e.variant}`,e.class,o.value],hideHeader:e.hideHeader&&"input"!==e.variant,style:e.style}),{title:()=>l.title?.()??t.createElementVNode("div",{class:"v-time-picker__title"},[n(e.title)]),header:()=>t.createVNode(sg,t.mergeProps(u,{ampm:g.value,hour:r.value,minute:i.value,period:v.value,second:s.value,viewMode:p.value,inputHints:"input"===e.variant,"onUpdate:hour":e=>r.value=e,"onUpdate:minute":e=>i.value=e,"onUpdate:second":e=>s.value=e,"onUpdate:period":e=>v.value=e,"onUpdate:viewMode":e=>p.value=e,ref:m}),null),default:()=>t.createVNode(Qf,t.mergeProps(c,{allowedValues:d,double:"hour"===p.value&&!g.value,format:"hour"===p.value?g.value?ag:e=>e:e=>tg(e,2),max:"hour"===p.value?g.value&&"am"===v.value?11:23:59,min:"hour"===p.value&&g.value&&"pm"===v.value?12:0,size:20,step:"hour"===p.value?1:5,modelValue:"hour"===p.value?r.value:"minute"===p.value?i.value:s.value,onChange:C,onInput:N,ref:f}),null),actions:l.actions})})}}),dg=rt({...it(),...Fl({variant:"text"})},"VToolbarItems"),vg=ft()({name:"VToolbarItems",props:dg(),setup:(e,{slots:a})=>(vt({VBtn:{color:t.toRef(()=>e.color),height:"inherit",variant:t.toRef(()=>e.variant)}}),It(()=>t.createElementVNode("div",{class:t.normalizeClass(["v-toolbar-items",e.class]),style:t.normalizeStyle(e.style)},[a.default?.()])),{})}),pg=rt({id:String,interactive:Boolean,text:String,...x(Ni({closeOnBack:!1,location:"end",locationStrategy:"connected",eager:!0,minWidth:0,offset:10,openOnClick:!1,openOnHover:!0,origin:"auto",scrim:!1,scrollStrategy:"reposition",transition:null}),["absolute","retainFocus","captureFocus","disableInitialFocus"])},"VTooltip"),mg=ft()({name:"VTooltip",props:pg(),emits:{"update:modelValue":e=>!0},setup(e,{slots:a}){const l=Zt(e,"modelValue"),{scopeId:n}=gi(),o=t.useId(),r=t.toRef(()=>e.id||`v-tooltip-${o}`),i=t.ref(),s=t.computed(()=>e.location.split(" ").length>1?e.location:e.location+" center"),u=t.computed(()=>"auto"===e.origin||"overlap"===e.origin||e.origin.split(" ").length>1||e.location.split(" ").length>1?e.origin:e.origin+" center"),c=t.toRef(()=>null!=e.transition?e.transition:l.value?"scale-transition":"fade-transition"),d=t.computed(()=>t.mergeProps({"aria-describedby":r.value},e.activatorProps))
return It(()=>{const o=Ci.filterProps(e)
return t.createVNode(Ci,t.mergeProps({ref:i,class:["v-tooltip",{"v-tooltip--interactive":e.interactive},e.class],style:e.style,id:r.value},o,{modelValue:l.value,"onUpdate:modelValue":e=>l.value=e,transition:c.value,absolute:!0,location:s.value,origin:u.value,role:"tooltip",activatorProps:d.value,_disableGlobalStack:!0},n),{activator:a.activator,default:(...t)=>a.default?.(...t)??e.text})}),Vo({},i)}}),fg=rt({...x(fr({collapseIcon:"$treeviewCollapse",expandIcon:"$treeviewExpand"}),["subgroup"])},"VTreeviewGroup"),gg=ft()({name:"VTreeviewGroup",props:fg(),setup(e,{slots:a}){const l=t.ref(),n=t.computed(()=>l.value?.isOpen?e.collapseIcon:e.expandIcon),o=t.computed(()=>({VTreeviewItem:{prependIcon:void 0,appendIcon:void 0,toggleIcon:n.value}}))
return It(()=>{const n=gr.filterProps(e)
return t.createVNode(gr,t.mergeProps(n,{ref:l,class:["v-treeview-group",e.class],subgroup:!0}),{...a,activator:a.activator?e=>t.createElementVNode(t.Fragment,null,[t.createVNode(Ja,{defaults:o.value},{default:()=>[a.activator?.(e)]})]):void 0})}),{}}}),hg=Symbol.for("vuetify:v-treeview"),yg=rt({loading:Boolean,hideActions:Boolean,hasCustomPrepend:Boolean,indentLines:Array,toggleIcon:_t,...Vr({slim:!0})},"VTreeviewItem"),bg=ft()({name:"VTreeviewItem",props:yg(),emits:{toggleExpand:e=>!0},setup(e,{slots:a,emit:l}){const n=t.inject(hg,{visibleIds:t.ref()}).visibleIds,o=t.ref(),r=t.computed(()=>o.value?.root.activatable.value&&o.value?.isGroupActivator),i=t.computed(()=>o.value?.link.isClickable.value||null!=e.value&&!!o.value?.list),s=t.computed(()=>!e.disabled&&!1!==e.link&&(e.link||i.value||r.value)),u=t.computed(()=>n.value&&!n.value.has(t.toRaw(o.value?.id)))
...
return l}return t.provide(hg,{visibleIds:h}),vt({VTreeviewGroup:{activeColor:r,baseColor:i,color:s,collapseIcon:t.toRef(()=>e.collapseIcon),expandIcon:t.toRef(()=>e.expandIcon)},VTreeviewItem:{activeClass:t.toRef(()=>e.activeClass),activeColor:r,baseColor:i,color:s,density:t.toRef(()=>e.density),disabled:t.toRef(()=>e.disabled),lines:t.toRef(()=>e.lines),variant:t.toRef(()=>e.variant)}}),It(()=>{const l=Fr.filterProps(e),r=wg.filterProps(e),i="boolean"==typeof e.indentLines?"default":e.indentLines
return t.createVNode(Fr,t.mergeProps({ref:v},l,{class:["v-treeview",{"v-treeview--fluid":e.fluid},e.class],role:"tree",openStrategy:"multiple",style:[{"--v-treeview-indent-line-color":e.indentLinesColor,"--v-treeview-indent-line-opacity":e.indentLinesOpacity},e.style],opened:p.value,activated:u.value,"onUpdate:activated":e=>u.value=e,selected:d.value,"onUpdate:selected":e=>d.value=e}),{default:()=>[0===h.value?.size&&!e.hideNoData&&(a["no-data"]?.()??t.createVNode(wr,{key:"no-data",title:n(e.noDataText)},null)),t.createVNode(wg,t.mergeProps(r,{density:e.density,returnObject:e.returnObject,items:o.value,parentIndentLines:e.indentLines?[]:void 0,indentLinesVariant:i}),a)]})}),{}}}),Ng=ft()({name:"VValidation",props:mo(),emits:{"update:modelValue":e=>!0},setup(e,{slots:t}){const a=fo(e,"validation")
return()=>t.default?.(a)}})
var Cg=Object.freeze({__proto__:null,VAlert:Hn,VAlertTitle:Mn,VApp:ka,VAppBar:Pl,VAppBarNavIcon:Fn,VAppBarTitle:$n,VAutocomplete:us,VAvatar:Gn,VBadge:Yn,VBanner:ms,VBannerActions:ds,VBannerText:vs,VBottomNavigation:gs,VBottomSheet:Vs,VBreadcrumbs:Cs,VBreadcrumbsDivider:Ss,VBreadcrumbsItem:xs,VBtn:Tn,VBtnGroup:zl,VBtnToggle:Gl,VCalendar:dc,VCard:Sc,VCardActions:pc,VCardItem:yc,VCardSubtitle:fc,VCardText:Vc,VCardTitle:gc,VCarousel:Pc,VCarouselItem:Tc,VCheckbox:So,VCheckboxBtn:lo,VChip:Ko,VChipGroup:Uo,VClassIcon:Bt,VCode:Bc,VCol:Uv,VColorPicker:ud,VCombobox:dd,VComponentIcon:At,VConfirmEdit:pd,VContainer:Mv,VCounter:Ai,VDataIterator:qd,VDataTable:Av,VDataTableFooter:Jd,VDataTableHeaders:yv,VDataTableRow:Sv,VDataTableRows:xv,VDataTableServer:Fv,VDataTableVirtual:Tv,VDatePicker:Vp,VDatePickerControls:sp,VDatePickerHeader:cp,VDatePickerMonth:mp,VDatePickerMonths:gp,VDatePickerYears:yp,VDefaultsProvider:Ja,VDialog:ys,VDialogBottomTransition:$a,VDialogTopTransition:Ma,VDialogTransition:Da,VDivider:Zo,VEmptyState:Sp,VExpandBothTransition:Za,VExpandTransition:qa,VExpandXTransition:Xa,VExpansionPanel:_p,VExpansionPanelText:Np,VExpansionPanelTitle:Ep,VExpansionPanels:Ap,VFab:Tp,VFabTransition:Fa,VFadeTransition:za,VField:$i,VFieldLabel:Ti,VFileInput:zp,VFooter:Op,VForm:Hp,VHotkey:Jp,VHover:tm,VIcon:Ql,VImg:gl,VInfiniteScroll:nm,VInput:ho,VItem:sm,VItemGroup:im,VKbd:Yp,VLabel:qn,VLayout:cm,VLayoutItem:vm,VLazy:mm,VLigatureIcon:Tt,VList:Fr,VListGroup:gr,VListImg:$r,VListItem:wr,VListItemAction:zr,VListItemMedia:Or,VListItemSubtitle:yr,VListItemTitle:br,VListSubheader:kr,VLocaleProvider:gm,VMain:ym,VMenu:Ii,VMessages:ro,VNavigationDrawer:Nm,VNoSsr:Cm,VNumberInput:Im,VOtpInput:Pm,VOverlay:Ci,VPagination:Zd,VParallax:Am,VProgressCircular:an,VProgressLinear:on,VRadio:Tm,VRadioGroup:Fm,VRangeSlider:Mm,VRating:Lm,VResponsive:ll,VRow:op,VScaleTransition:La,VScrollXReverseTransition:ja,VScrollXTransition:Oa,VScrollYReverseTransition:Wa,VScrollYTransition:Ha,VSelect:is,VSelectionControl:to,VSelectionControlGroup:Jn,VSheet:Pi,VSkeletonLoader:Gm,VSlideGroup:Ho,VSlideGroupItem:Km,VSlideXReverseTransition:Ua,VSlideXTransition:Ya,VSlideYReverseTransition:Ka,VSlideYTransition:Ga,VSlider:ed,VSnackbar:Zm,VSnackbarQueue:Jm,VSpacer:rp,VSparkline:df,VSpeedDial:pf,VStepper:Ef,VStepperActions:gf,VStepperHeader:hf,VStepperItem:Vf,VStepperWindow:Sf,VStepperWindowItem:xf,VSvgIcon:Dt,VSwitch:_f,VSystemBar:Rf,VTab:Tf,VTable:Cv,VTabs:Lf,VTabsWindow:Ff,VTabsWindowItem:Mf,VTextField:Hi,VTextarea:jf,VThemeProvider:Wf,VTimePicker:cg,VTimePickerClock:Qf,VTimePickerControls:sg,VTimeline:Xf,VTimelineItem:Kf,VToolbar:Cl,VToolbarItems:vg,VToolbarTitle:Ca,VTooltip:mg,VTreeview:xg,VTreeviewGroup:gg,VTreeviewItem:bg,VValidation:Ng,VVirtualScroll:qi,VWindow:Ic,VWindowItem:Ac})
function Eg(e,t){e._mutate?.[t.instance.$.uid]&&(e._mutate[t.instance.$.uid].observer.disconnect(),delete e._mutate[t.instance.$.uid])}const Ig={mounted:function(e,t){const a=t.modifiers||{},l=t.value,{once:n,immediate:o,...r}=a,i=!Object.keys(r).length,{handler:s,options:u}="object"==typeof l?l:{handler:l,options:{attributes:r?.attr??i,characterData:r?.char??i,childList:r?.child??i,subtree:r?.sub??i}},c=new MutationObserver((a=[],l)=>{s?.(a,l),n&&Eg(e,t)})
o&&s?.([],c),e._mutate=Object(e._mutate),e._mutate[t.instance.$.uid]={observer:c},c.observe(e,u)},unmounted:Eg}
function _g(e,t){const{self:a=!1}=t.modifiers??{},l=t.value,n="object"==typeof l&&l.options||{passive:!0},o="function"==typeof l||"handleEvent"in l?l:l.handler,r=a?e:t.arg?document.querySelector(t.arg):window
r&&(r.addEventListener("scroll",o,n),e._onScroll=Object(e._onScroll),e._onScroll[t.instance.$.uid]={handler:o,options:n,target:a?void 0:r})}function Pg(e,t){if(!e._onScroll?.[t.instance.$.uid])return
const{handler:a,options:l,target:n=e}=e._onScroll[t.instance.$.uid]
n.removeEventListener("scroll",a,l),delete e._onScroll[t.instance.$.uid]}const Rg={mounted:_g,unmounted:Pg,updated:function(e,t){t.value!==t.oldValue&&(Pg(e,t),_g(e,t))}}
const Ag=function(e,a){const n=function(e,a){return function(n,o,r){const i="function"==typeof a?a(o):a,s=o.value?.text??o.value??i?.text,u=g(o.value)?o.value:{},c=()=>s??n.textContent,d=(r.ctx===o.instance.$?function(e,t){const a=new Set,n=t=>{for(const l of t){if(!l)continue
...
return t.nextTick(()=>a.update()),u.mount=e,n}}("boolean"!=typeof __VUE_OPTIONS_API__||__VUE_OPTIONS_API__)&&u.mixin({computed:{$vuetify(){return t.reactive({defaults:Fg.call(this,ct),display:Fg.call(this,xo),theme:Fg.call(this,da),icons:Fg.call(this,Pt),locale:Fg.call(this,ra),date:Fg.call(this,Nu)})}}})},unmount:function(){u.stop()},defaults:e,display:a,theme:l,icons:c,locale:d,date:v,goTo:p}})}function Fg(e){const t=this.$,a=t.parent?.provides??t.vnode.appContext?.provides
if(a&&e in a)return a[e]}Bg.version="4.0.2"
const $g=(e={})=>Bg({components:Cg,directives:Dg,...e}),Mg="4.0.2"
$g.version=Mg,e.blueprints=Ot,e.components=Cg,e.createVuetify=$g,e.directives=Dg,e.useDate=Eu,e.useDefaults=function(e={},t){const{props:a,provideSubDefaults:l}=pt(e,t)
...
return e&&("INPUT"===e.tagName||"TEXTAREA"===e.tagName||e.isContentEditable||"true"===e.contentEditable)}())if(function(e,t,a){const{modifiers:l,actualKey:n}=function(e){const t=["ctrl","shift","alt","meta","cmd"],{keys:a}=Mu(e.toLowerCase())
...
else n+=i,t++}return n}function u(e){return!!e&&s(e)===s(i(e))}return{isValid:u,isComplete:function(e){return!!e&&(i(e).length===a.value.length&&u(e))},mask:i,unmask:s}},e.useRtl=ca,e.useTheme=wa,e.version=Mg})
